                                       ...
                                       <hr />
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                <form class="form-horizontal" id="batchform" method="POST" action="<?php echo base_url()?>entrytest/allocate_room" enctype="multipart/form-data" />
                                                ...
                                                <div style="width: 100%; float: left; margin-bottom: 25px; " class="control-group">
                                                 ...
                                                 <div style="width: 100%; float: left; margin-bottom: 25px; " class="control-group">
                                                    <label style="width: 160px;" class="control-label" for="id-date-picker-1">Start Date :<img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>

                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                            <input onchange="resetProgram()" style="width: 188px;" type="text" name="s_date" id="s_date" value="<?php echo set_value('s_date'); ?>" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <label style="width: 160px; float: left;" class="control-label" for="email">Students :<img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
           ...
           $("#students").keyup(function(){
            ...
            function getCapacity(id)
            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>entrytest/getCapacity",
            ...
            function getStudents(id)
            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>entrytest/getStudents",
