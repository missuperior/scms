                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <form name="postChallan" id="postChallan" onsubmit="return confirm('Are you sure ?');" action="<?php echo  base_url()?>examination/update_mid_result_cr" method="post" enctype="multipart/form-data">
...
//                                                                    if($result_added){
                                                            ...
                                                            <td><input style="width:50px" name="o_marks1[]" type="text" value="<?php echo $mid_result->mid_value_1; ?>" id="a<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks2[]" type="text" value="<?php echo $mid_result->mid_value_2; ?>" id="b<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks3[]" type="text" value="<?php echo $mid_result->mid_value_3; ?>" id="c<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td>
                                                                <select name="status[]" style="width:50px">
                                                                    <option <?php if($mid_result->status == 'P')echo 'selected="selected"';?> value="P">P</option>
                                                                    <option  <?php if($mid_result->status == 'A')echo 'selected="selected"';?> value="A">A</option>                                                                        
                                                                </select>
                                                            </td>
                                                            ...
                                                            <input type="hidden" name="mid_result_id[]" value="<?php echo $mid_result->mid_result_id;?>" class="span6">
