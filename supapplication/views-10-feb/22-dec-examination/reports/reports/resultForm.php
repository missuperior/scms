                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Student Result Form</h4>                               
                            </div>
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>examination/result_report" />
...
<?php } ?>																			
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    <span style="color: red; font-size: 11px;">Note : Leave the 'Subject' Field empty to view all subject's result</span>
                                                  </div>
                                                </div>
