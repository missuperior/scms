                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">                               
                                <h4 class="lighter">Result Summary (Program Wise Detail)</h4>
                            </div>
                                    ...
                                    <div class="row-fluid">													
                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                <form target="_BLANK" class="form-horizontal" id="batchform" method="POST" action="<?php echo base_url() ?>admission_r/program_detail_info" enctype="multipart/form-data" />
                                            ...
                                            <div style="width: 100%; float: left; margin-bottom: 25px; " class="control-group">
                                                 ...
                                                 <div style="width: 100%;margin-bottom: 25px; float: left" class="control-group">
                                                    <label style="width: 130px;" class="control-label" for="email">Status:<img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>

                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="status" name="status" class="chzn-select" data-placeholder="Click to Choose...">
                                                ...
                                                <div style="width: 100%; float: left;margin-bottom: 25px;" class="control-group">
                                                    <label style="width: 150px;" class="control-label" for="email"> Greater Equal To : </label>

                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="number" name="greater_than" id="greater_than" value="<?php echo set_value('name'); ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 100%; float: left;margin-bottom: 25px;" class="control-group">
                                                    <label style="width: 132px;" class="control-label" for="email"> Less Equal To : </label>

                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="number" name="less_than" id="less_than" value="<?php echo set_value('name'); ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
