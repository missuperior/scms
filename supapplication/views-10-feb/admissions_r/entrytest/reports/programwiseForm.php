                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">                               
                                <h4 class="lighter">Result Summary (Program Wise)</h4>
                            </div>
                                    ...
                                    <div class="row-fluid">													
                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                <form target="_BLANK" class="form-horizontal" id="batchform" method="POST" action="<?php echo base_url() ?>admission_r/program_detail" enctype="multipart/form-data" />
