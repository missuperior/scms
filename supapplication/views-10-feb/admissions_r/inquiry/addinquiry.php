                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <form class="form-horizontal" name="inquiryform" id="inquiryform" method="POST" action="<?php echo base_url(); ?>admission_r/add_inquiry" enctype="multipart/form-data" />
                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <div id="others" style="display:none">
                                                    ...
                                                    <div style="width: 75%; float: left;margin-bottom: 25px;" class="control-group">
                                                            ...
                                                            <div class="controls" style="margin-left: 145px;">
                                                                <div class="span12">
                                                                    <input style="width: 200px;" type="text" name="new_reference" id="new_reference" value="<?php echo set_value('name'); ?>" class="span5" />
                                                                </div>
                                                            </div>
                                                    </div>
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="ref_name" id="ref_name" value="<?php echo set_value('name'); ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 50%;margin-bottom: 25px; float: left" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="ref_campus" name="ref_campus" class="select2" data-placeholder="Click to Choose...">
                                                ...
                                                <div style="width: 50%; margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="ref_designation" id="ref_designation" value="<?php echo set_value('name'); ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="campus" name="campus" class="chzn-select" data-placeholder="Click to Choose...">
                                                                <option value="">-- Select Campus --</option>
                                                                <?php foreach ($campus as $row) { ?>
                                                                    <option <?php if (set_value('campus') == $row['campus_id']){ echo 'selected="selected"';}else if($this->session->userdata('campus_id') == $row['campus_id'] ){echo 'selected="selected"';} ?> value="<?php echo $row['campus_id'] ?>"><?php echo $row['campus_name'] ?></option> 
                                                                 <?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="qualification" name="qualification" class="chzn-select" data-placeholder="Click to Choose...">
                                                                ...
                                                                <option value="Intermediate or equivalent" <?php if (set_value('qualification') == 'Intermediate or equivalent') echo '"selected=selected"'; ?> />Intermediate or equivalent
                                                                <option value="Bachelor 2 years or equivalent" <?php if (set_value('qualification') == 'Bachelor 2 years or equivalent') echo '"selected=selected"'; ?> />Bachelor 2 years or equivalent
                                                                <option value="Bachelor 4 years or equivalent" <?php if (set_value('qualification') == 'Bachelor 4 years or equivalent') echo '"selected=selected"'; ?> />Bachelor 4 years or equivalent
                                                                <option value="PGD or equivalent" <?php if (set_value('qualification') == 'PGD or equivalent') echo '"selected=selected"'; ?> />PGD or equivalent
                                                                <option value="Master 1.5 years or equivalent" <?php if (set_value('qualification') == 'Master 1.5 years or equivalent') echo '"selected=selected"'; ?> />Master 1.5 years or equivalent
                                                                <option value="Master 2 years or equivalent" <?php if (set_value('qualification') == 'Master 2 years or equivalent') echo '"selected=selected"'; ?> />Master 2 years or equivalent
                                                                <option value="Master 3.5 years or equivalent" <?php if (set_value('qualification') == 'Master 3.5 years or equivalent') echo '"selected=selected"'; ?> />Master 3.5 years or equivalent
                                                                <option value="MS / M.Phil" <?php if (set_value('qualification') == 'MS / M.Phil') echo '"selected=selected"'; ?> />MS / M.Phil
                                                                <option value="PhD" <?php if (set_value('qualification') == 'PhD') echo '"selected=selected"'; ?> />PhD
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="total_marks" id="total_marks" maxlength="4" value="<?php echo set_value('total_marks'); ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 75px;" type="text" name="obtained_marks" id="obtained_marks" value="<?php echo set_value('obtained_marks'); ?>" class="span5" />
                                                            
                                                            <input name="result_waiting" value="Result Waiting" type="radio"  id="rad"   />
                                                            <span class="lbl"> Result Awaiting</span>
                                                ...
                                                <div style="width: 100%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <textarea style="width:86%; height: 75px" name="remarks" id="remarks" value="<?php echo set_value('remarks'); ?>"></textarea>
...
<script type="text/javascript">
    ...
    $('#rad').change(function (event) {
        ...
        $("#obtained_marks").prop('readonly', true);
    });
    
    $('#obtained_marks').click(function (event) {
        $("#obtained_marks").prop('readonly', false);
