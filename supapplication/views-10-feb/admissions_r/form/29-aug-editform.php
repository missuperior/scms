              ...
              <div class="widget-body">
                <div class="widget-main">
                  ...
                  <div class="row-fluid">
                    ...
                    <form class="form-horizontal" id="studentform" method="POST" action="<?php echo base_url(); ?>admission_r/update_studentform" enctype="multipart/form-data" />
                    ...
                    <div class="step-content row-fluid position-relative" id="step-container">
                      <div class="step-pane active" id="step1">
                        ...
                        <div style="width: 50%;margin-bottom: 15px; float: left" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="section" name="section" class="select2" data-placeholder="Click to Choose...">
                                <option value="">-- Select Section --</option>
                                  <?php foreach ($sections as $row) { ?>
                                      <option <?php if (set_value('section') == $row['section_id']){echo 'selected="selected"';} if($student[0]['section_id'] == $row['section_id']) {echo 'selected="selected"';} ?> 
                                      value="<?php echo $row['section_id'] ?>"><?php echo $row['section'] ?></option> 
                                  <?php } ?>																			
                              </select>
                            </div>
                          </div>
