                                            ...
                                            <tr>                                                                                        
                                                ...
                                                <td>
                                                    <div class="hidden-phone visible-desktop action-buttons">
                                                        <p class="green">
                                                           <?php if($row['admission_stage'] == 3)
                                                            {  echo 'Completed'; }else{
                                                            ?>    
                                                            In Progress 
                                                            | <a href="<?php echo site_url(); ?>admission_r/view_form_student_info/<?php echo $row['FORMID'];?>">Change Program</a> 
                                                            | <a href="<?php echo site_url(); ?>admission_r/edit_studentform/?student_id=<?php echo $row['student_id'];?>">Edit</a>
