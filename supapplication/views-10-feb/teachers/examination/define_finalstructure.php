                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>teachers/define_final_structure" enctype="multipart/form-data" />
                                                ...
                                                <input type="hidden" name="course_type" value="<?php echo $course_type; ?>" class="span5" />
                                                <input type="hidden" name="credit_hours" value="<?php echo $credit_hours; ?>" class="span5" />
                                                ...
                                                <input type="hidden" name="teacher_id" value="<?php echo $teacher_id; ?>" class="span5" />
                                    
                                                <?php if($result['course_type'] =! 'Lab' or $_GET['crh'] != '1'){ ?>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <input style="width: 150px;" placeholder="Lab" type="text" name="title[]" id="title7" class="span5" value="Lab"  /> - 
                                                            <input style="width: 100px;" placeholder="Marks" type="text" name="marks[]" id="marks7" class="span6" />
                                                        </div>
                                                    </div>
                                                </div>
