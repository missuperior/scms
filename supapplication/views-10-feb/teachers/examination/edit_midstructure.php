            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>teachers/update_mid_structure" enctype="multipart/form-data" />

                                                
<!--                                                 <div class="control-group" style="margin-bottom: 0px; color: mediumslateblue">
                                                    <label style="margin-bottom: 25px; margin-left: 140px;" class="control-label" for="city">Mid Total Marks :</label>
                                                    <label style="width:90px" class="control-label" for="city"><?php echo $mid->mid_value_1+$mid->mid_value_2+$mid->mid_value_3; ?></label>                                                    
                                                </div>-->
                                                ...
                                                <input type="hidden" name="mid_structure_id" value="<?php echo $mid->mid_course_structure_id; ?>" class="span5" />
