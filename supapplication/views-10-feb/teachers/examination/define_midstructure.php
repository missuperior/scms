                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Define Mid Structure</h4>
                            </div>
                        ...
                        <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>teachers/define_mid_structure" enctype="multipart/form-data" />
