    ...
    <ul class="nav nav-list">
        ...
        <li <?php  if(($controller == 'courses' or $controller == 'programmanagers') && $methd != 'dashboard'){echo 'class="active open"';}  ?>>
            ...
            <ul class="submenu">
                ...
                <li <?php  if(($controller == 'programmanagers')  && $methd == 'add_course_form' || $methd == 'view_courses' || $methd == 'copy_program_course' ) echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'copy_program_course' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>programmanagers/copy_program_course">
                                <i class="icon-leaf"></i>
                                Copy Courses
                            </a>
                        </li>
...
<!--                <li <?php  if(($controller == 'programmanagers')  && $methd == 'add_student_course_reg_form' || $methd == 'view_student_course_reg') echo  'class="active open" ' ;?>>
        ...
        <li>
            ...
            <ul class="submenu">
                <li <?php  if( $this->uri->segment(1) == 'programmanagers' &&  $methd == 'allocate_teacher_to_section_form' || $methd == 'create_student_sections' || $methd == 'view_student_sections_form'  || $methd == 'remaining_student_section_form') echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-double-angle-right"></i>
                        Student Sections
                        <b class="arrow icon-angle-down"></b>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'remaining_student_section_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>programmanagers/remaining_student_section_form">
                                <i class="icon-leaf"></i>
                                View Sections
                            </a>
                        </li>   
            ...
            <ul class="submenu">
                ...
                <li <?php  if(($controller == 'programmanagers')  && $methd == 'add_advisor_form'   or   ( $methd == 'section_course_settings_list')) echo  'class="active open" ' ;?>>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'advisor_section_course_settings_list_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>programmanagers/advisor_section_course_settings_list_form">
                                <i class="icon-leaf"></i>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'allocatedTeacherCourseSectionListForm' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>programmanagers/allocatedTeacherCourseSectionListForm">
                                <i class="icon-leaf"></i>
