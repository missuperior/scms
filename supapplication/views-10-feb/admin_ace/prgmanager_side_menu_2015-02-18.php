...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav nav-list">
        ...
        <li <?php  if($this->uri->segment(1) == 'programmanagers' && $methd == 'add_room_form' || $methd == 'allocate_room_form' || $methd == 'add_entrytest_result_form' || $methd == 'view_allocated' || $methd == 'view_rooms' || $methd == 'add_test_form' || $methd == 'view_tests' ) {echo  'class="active open"' ;}?> > 
...
<!--                         <li <?php echo $methd == 'award_list_form' ? 'class="active" ' : ''; ?>>
                ...
                <li <?php  if($controller == 'programmanagers' && $methd == 'add_entrytest_result_form' ) echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-double-angle-right"></i>
                        Data Entry
                        <b class="arrow icon-angle-down"></b>
                    ...
                    <ul class="submenu">
                         ...
                         <li <?php echo $methd == 'add_entrytest_result_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>programmanagers/add_entrytest_result_form">
                                <i class="icon-leaf"></i>
                                Add Result
                            </a>
                        </li> 
