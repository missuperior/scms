<div class="sidebar" id="sidebar">
    ...
    <ul class="nav nav-list">
      ...
      <?php if($controller == 'admin' && $this->session->userdata('account_role_id') == 1 && $this->session->userdata('username')=='bilal.hanif'){?>  
      ...
      <?php }if($controller == 'admin' && $this->session->userdata('account_role_id') == 1 && $this->session->userdata('username')!='bilal.hanif'){?>  
        ...
        <li <?php  if(($controller == 'courses' or $controller == 'admin') && $methd != 'dashboard'){echo 'class="active open"';}  ?>>
            ...
            <ul class="submenu">
                ...
                <li <?php  if($methd == 'add_user_form' || $methd == 'view_users') echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-double-angle-right"></i>
                        User Module
                        <b class="arrow icon-angle-down"></b>
         ...
         <li <?php  if($this->uri->segment(1) == 'admission_reports' ) {echo  'class="active open"' ;}?> > 
            ...
            <ul class="submenu">
              ...
              <!-- Follow Up Reports Starts-->
                ...
                <!-- Initial report Start -->
                <li <?php  if($methd == 'campus_wise_form_analysis' || $methd == 'adm_analysis_form') echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-double-angle-right"></i>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'adm_analysis_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>admission_reports/adm_analysis_form">
                                <i class="icon-leaf"></i>
...
<!--                    <ul class="submenu">
                ...
                <!-- Initial report Start -->
                <li <?php  if($methd == 'reference_report_form' || $methd == 'adm_ref_summary_report_form') echo  'class="active open" ' ;?>>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-double-angle-right"></i>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php echo $methd == 'adm_ref_summary_report_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>admission_reports/adm_ref_summary_report_form">
                                <i class="icon-leaf"></i>
                                Admission Summary
                            </a>
                        </li> 
            ...
            <ul class="submenu">
              <li <?php  if($controller == 'admission_r' && $methd == 'award_list_form' || $methd == 'award_list' || $methd == 'view_marks'  ) echo  'class="active open" ' ;?>>
                   ...
                   <ul class="submenu">                        
                        ...
                        <li <?php echo $methd == 'showhideResult_form' ? 'class="active" ' : ''; ?>>
                            <a href="<?php echo base_url()?>admission_r/showhideResult_form">
                                <i class="icon-leaf"></i>
                                Show / Hide Result
                            </a>
                        </li>
