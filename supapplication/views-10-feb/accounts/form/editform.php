              ...
              <div class="widget-body">
                <div class="widget-main">
                  ...
                  <div class="row-fluid">
                    ...
                    <form class="form-horizontal" id="studentform" method="POST" action="<?php echo base_url(); ?>accounts/update_studentform" enctype="multipart/form-data" />
                            ...
                            <div class="span12">
                              <select style="width: 201px;" id="batch" name="batch" class="chzn-select" data-placeholder="Click to Choose...">
                                  ...
                                  <?php foreach ($batches as $row) { 
                                      ...
                                      ?>
                                        <option <?php if($row['batch_id'] == $student[0]['batch_id'] )echo 'selected="selected"';?> value="<?php echo $row['batch_id'] ?>"><?php echo $row['batch'] . ' - ' . $row['batch_type'] ?></option> 
                                      <?php } //} ?>																			
                              </select>
                            </div>
                          </div>
