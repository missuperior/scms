                                    ...
                                    <div class="widget-main">
                                        ...
                                        <div>
                                            <select onchange="setSearchValue(this.value)" style="width:265px" >
                                                ...
                                                <option value="2">Add | View Package</option>
                                                <option value="3">Add Fine | Post Challan</option>                                                
                                            </select>
                                        </div>
                                        <form target="_blank" name="form" method="post" action="<?php echo base_url(); ?>accounts/quick_search">
                                            <div>
                                        ...
                                        <form target="_blank" name="roll" method="post" action="<?php echo base_url(); ?>accounts/quick_search">
                                            <div>
                                                <input style="margin-top:12px" type="text" name="roll_no" placeholder="Entry Roll No"/>
                                                <input type="hidden" name="type" class="type" value="1"/>
                                                <input style=" background-color: #006e6f;  color: #fff;  font-weight: bold;   height: 32px;    width: 40px;" type="submit" name="roll" value="Go" />
                                            </div>
                                        </form>

                                        <form target="_blank" name="challan" method="post" action="<?php echo base_url(); ?>accounts/quick_search">
                                            <div>
                                                <input style="margin-top:12px" type="text" name="challan_no" placeholder="Entry Challan No"/>
                                                <input type="hidden" name="type" class="type" value="1"/>
                                                <input style=" background-color: #006e6f;  color: #fff;  font-weight: bold;   height: 32px;    width: 40px;" type="submit" name="challan" value="Go" />
                                            </div>
                                        </form>
