                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main" style="min-height: 100px">
                                <form target="_blank" class="form-horizontal" name="searchChallan" id="searchChallan" method="POST" action="<?php echo  base_url()?>accounts/add_submitted_fee_form2" enctype="multipart/form-data" />
