                                        ...
                                        <?php
                                         ...
                                         ?>
                                            <tr style="font-size:10px">                                                                                        
                                                ...
                                                <form name="postChallan" id="postChallan" action="<?php echo  base_url()?>accounts/post_challan" method="post" enctype="multipart/form-data">
                                                <td>                                                    
                                                    <select onchange="slipNo(this.value);" name="type" style="width:100px">
                                                ...
                                                <td> <input class="span12" name="slip_no" id="slip_no" type="text" readonly/> </td> 
                                                </form>
                                                <td>                                              
                                                    <a style="cursor:pointer" id="post_challan" class="green" >
                                                            Post
                                                    </a> |  
                                                    <a style="cursor:pointer" href="<?php echo base_url()?>accounts/add_fine_form/?installment_id=<?php echo $row['installment_id']; ?>" class="green" >
                                                            Add Fine
                                                    </a> 
                                                </td>
                                             </tr>
