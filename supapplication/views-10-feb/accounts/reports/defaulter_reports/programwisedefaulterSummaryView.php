                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">Program Wise Defaulter Summary Report</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="2"><h3 style="text-align:right">Program Wise Defaulter Summary Report</h3></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">                                                
                                               <td colspan="1"><b>Campus : <?php  if($campus_id == 0) { echo 'All';}else{ echo $defaulter_report[0]['campus_name'];} ?></b></td>
                                        ...
                                        for($i=0; $i<count($defaulter_report);$i++){  ?>
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo number_format($defaulter_report[$i]['defaulter']); ?></td>
                                            </tr>
                                          <?php $g_total = $g_total + $defaulter_report[$i]['defaulter']; 
                                           } ?>  
                                        </tbody>
                                        <tr>
