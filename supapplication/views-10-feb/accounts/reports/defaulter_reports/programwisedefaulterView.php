                            ...
                            <div class="row-fluid">                                             
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           ...
                                           <tr style="font-size: 10px">                                                
                                               <td colspan="2"><b>Campus : <?php  echo $defaulter_report[0]['campus_name']; ?></b></td>
                                                <td colspan="1"><b>Campaign : <?php echo $defaulter_report[0]['campaign_name']; ?></b></td>
                                               <td colspan="1"><b>Section : <?php  echo $section; ?></b></td>
                                        ...
                                        for($i=0; $i<count($defaulter_report);$i++){  ?>
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $i+1; ?></td>
                                                <td><a target="_blank" href="<?php echo site_url();?>warning_letter.php?name=<?php echo $defaulter_report[$i]['student_name']?>&roll_num=<?php echo $defaulter_report[$i]['roll_no'] ?>&part=<?php echo $defaulter_report[$i]['part']?>&due_date=<?php echo $defaulter_report[$i]['due_date'] ?>&class=<?php echo $defaulter_report[$i]['program_name'] ?>&gender=<?php echo $defaulter_report[$i]['gender'] ?>">
                                                <?php echo $defaulter_report[$i]['roll_no']; ?></a></td>
