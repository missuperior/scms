                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Campus Revenue Summary Report Form</h4>                               
                            </div>
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>account_reports/campus_wise_revenue_summary_report" />
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="status" name="status" class="chzn-select" data-placeholder="Click to Choose...">
                                                                ...
                                                                <option value="2">Left/Freeze</option>
                                                                <option value="0">All</option>								
                                                            </select>
                                                        </div>
                                                    </div>
