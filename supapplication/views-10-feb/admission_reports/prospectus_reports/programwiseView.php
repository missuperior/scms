                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Program Wise Prospectus Report</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="6"><h2 style="text-align:left; font-size:23px">Program Wise Prospectus Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                                
                                               <td colspan="3"><b>Campus : <?php  if($campus_id == 0) { echo 'All';}else{ echo $prospectus_report[0]['campus_name'];}?></b></td>
                                                <td colspan="3"><b>Campaign : <?php echo $prospectus_report[0]['campaign_name']; ?></b></td>
                                                <td colspan="3"><b style="font-size: 12px; color: #553333">Program : <?php if($program_id == 0){echo 'All';}else{ echo $prospectus_report[0]['program_name'];} ?></b></td>
                                        ...
                                        for($i=0; $i<count($prospectus_report);$i++){  
                                            ...
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $prospectus_report[$i]['shift']; ?></td>
                                        ...
                                        <tr style="font-size: 10px">
                                               ...
                                               <td colspan="8" style="text-align: right"><b><?php echo 'Grand Total'; ?></b></td>
