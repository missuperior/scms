                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           ...
                                           <tr style="font-size: 10px">
                                               ...
                                               <?php 
                                               if($inquiry_type == '0'){$inquiry_type = 'All';}
                                               if(count($inquiry_report) > 1){?>
                                               <td colspan="2"><b>Inquiry Type : <?php echo $inquiry_type ;?></b></td>
                                               <?php } else{?>
                                               <td colspan=""><b>Inquiry Type : <?php if($inquiry_type == 0){echo 'All';}else{ echo $inquiry_type;} ?></b></td>
                                               <?php } ?>
