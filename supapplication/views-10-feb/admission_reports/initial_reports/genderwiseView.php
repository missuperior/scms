                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Gender Wise Inquiry Report</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="6"><h2 style="text-align:right">Gender Wise Inquiry Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                        ...
                                        for($i=0; $i<count($inquiry_report);$i++){  ?>
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $inquiry_report[$i]['gender']; ?></td>
