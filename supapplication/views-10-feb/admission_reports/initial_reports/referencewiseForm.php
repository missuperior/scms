                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Reference Wise Report Form</h4>                               
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/reference_wise_report_initial" enctype="multipart/form-data" />
                                                ...
                                                <div class="control-group">
                                                 ...
                                                 <select style="width: 200px;" id="reference" name="reference" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <?php foreach ($reference as $row) { ?>
                                                                    <option value="<?php echo $row['reference_id'] ?>"><?php echo $row['reference_source'] ?></option>
                                                                <?php } ?>
                                                                    <option <?php if (set_value('reference_id') == 0) echo '"selected=selected"' ?> value="0">All</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                  </div>
