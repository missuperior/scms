                                ...
                                <div class="row-fluid">         
                                   ...
                                   <?php if(count($initial_report) > 0 ){?>
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Initial Summary (Program) Report</h3>
                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">  
                                               <?php if(count($initial_report) > 1){?>
                                               ...
                                               <?php } ?>
                                               <td colspan="2"><h2 style="text-align:right">Initial Summary (Program)</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                                
                                               <?php if(count($initial_report) > 1){?>
                                               <td colspan="2"><b>Inquiry Type : <?php echo $initial_report[0]['inquiry_type']; ?></b></td>
                                               <?php } else{?>
                                               <td colspan=""><b>Inquiry Type : <?php echo $initial_report[0]['inquiry_type']; ?></b></td>
                                               <?php } ?>
                                                <td colspan="1"><b>Campaign : <?php echo $initial_report[0]['campaign_name']; ?></b></td>
                                            ...
                                            <tr style="font-size: 10px">                                                
                                                ...
                                                <th><?php echo $initial_report[$i]['campus_name']?></th>
                                                <?php } ?>              
                                                <th>Total</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $initial_report[0]['program_name']; ?></td>
                                               <?php
                                               $totl =0;
                                               for($j=0; $j < count($initial_report); $j++){
                                                   $totl    = $totl + $initial_report[$j]['total'];
                                                   ?>
                                                <th><?php echo $initial_report[$j]['total']?></th>
                                                <?php } ?>  
                                                <td><?php echo $totl; ?></td>
                                           </tr>
