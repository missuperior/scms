...
<?php if (count($initial_report) > 0) { ?>
                <div class="table-header">
                  <h3 id="title">User Wise Summary Initial Report</h3>
                </div>
                <table id="example" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr style="font-size: 10px">
                      ...
                      <td colspan="3"><h2 style="text-align:right">User Wise Summary Initial Report</h2></td>
                    </tr>
                    <tr style="font-size: 10px">
                      <td><b>Campus : <?php echo $initial_report[0]['campus_name']; ?></b></td>
                      <td><b>Campaign : <?php echo $initial_report[0]['campaign_name']; ?></b></td>
                      <td><b style="font-size: 12px; color: #553333">User : <?php echo $initial_report[0]['user_name']; ?></b></td>
                  ...
                  <tbody>
                    ...
                    for ($i = 0; $i < count($initial_report); $i++) {
                      ...
                      <tr style="font-size: 10px">
                        ...
                        <td><?php echo $x = $initial_report[$i]['program_count']; ?></td>
                      </tr>
