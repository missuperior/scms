                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/program_wise_report_initial" enctype="multipart/form-data" />
...
<?php } ?>								
                                                ...
                                                <div class="control-group">
                                                 ...
                                                 <select style="width: 200px;" id="program" name="program" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <?php } ?>	
                                                                <option <?php if (set_value('program') == 0) echo '"selected=selected"' ?> value="0">All</option> 
