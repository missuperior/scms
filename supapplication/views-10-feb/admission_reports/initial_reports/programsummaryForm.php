                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Initial Summary (Program) Form</h4>                               
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/program_summary_report_initial" enctype="multipart/form-data" />
