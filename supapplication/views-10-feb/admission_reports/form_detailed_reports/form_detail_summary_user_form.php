                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Summary Report User Wise</h4>
                            </div>
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/form_detail_summary_user_view" enctype="multipart/form-data" />
                                    <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                  
                                                
                                                <div class="control-group">
                                                    <label style="width: 130px;" class="control-label" for="city">City:<img src="<?php echo base_url()?>assets/img/star.jpg" width="6"/></label>
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="city" name="city" class="select2" data-placeholder="Click to Choose...">
                                                                <?php foreach ($cities as $row) { ?>
                                                                    <option <?php if (set_value('city') == $row['city_id']) echo '"selected=selected"' ?> value="<?php echo $row['city_id'] ?>"><?php echo $row['city_name'] ?></option> 
                                                                <?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="control-group">
                                                    <label style="width: 130px;" class="control-label" for="operators">User:<img src="<?php echo base_url();?>assets/img/star.jpg" width="6"/></label>

                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="user" name="sub_login" class="select2" data-placeholder="Click to Choose...">                                                                
                                                                <?php foreach ($operators as $row) { ?>
                                                                    <option <?php if (set_value('sub_login') == $row['sub_login']) echo '"selected=selected"' ?> value="<?php echo $row['sub_login_id'] ?>"><?php echo $row['sub_login'] ?></option> 
                                                                <?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
