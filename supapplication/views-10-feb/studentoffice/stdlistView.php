                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">PROGRAM WISE STUDENTS LIST</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="2"><h2 style="text-align:left; font-size:23px">Program Wise Students List</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                               ...
                                               <td colspan="2"><b>Program : <?php  echo $address_report[0]['program_name'];?></b></td>
                                                <td colspan="2"><b>Campaign : <?php echo $address_report[0]['campaign_name']; ?></b></td>                                                
