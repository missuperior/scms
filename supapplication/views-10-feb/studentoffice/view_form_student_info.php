              ...
              <div class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">EDIT STUDENT FORM</h4>                               
                  ...
                  <div class="row-fluid">
                    ...
                    <form class="form-horizontal" id="studentform" method="POST" action="<?php echo base_url(); ?>studentoffice/update_student_form_info" enctype="multipart/form-data" />
                        ...
                        <div style="width: 50%; float: left;margin-bottom: 15px;" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                                ...
                                <input style="width: 200px;" type="hidden" name="student_id" id="student_id" value="<?php echo $student_id;?>" class="span6" />
