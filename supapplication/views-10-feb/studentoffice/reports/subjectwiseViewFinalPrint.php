...
<table  width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr style="height: 30px; color: white ">    
    <th width="15%" align="center" valign="middle" bgcolor="#6B6565" scope="col"> <?php  echo '  '.$students[0]['campus_name']; ?></th>
    <th width="20%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><?php  echo '  '.$students[0]['program_name']; ?></th>
    <th width="20%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><?php  echo '  '.$students[0]['course_name']; ?></th>
    <th width="10%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><?php  echo '  '.$students[0]['batch_type'].' '.$students[0]['batch']; ?></th>
    <th width="10%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><b>Semester &nbsp;&nbsp;</b> <?php  echo '  0'.$students[0]['semester']; ?></th>    
...
<table style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 8px; font-weight: bold; color: #000;" width="100%" border="1" cellspacing="0" cellpadding="0">
  <THEAD>
    <tr style="color:white; height: 30px; line-height: 30px; font-size: 11px;">
<!--    <th width="3%" height="82" align="center" valign="top" bgcolor="#FFFFFF" scope="col">
    ...
    <th width="16%" align="center" valign="middle" bgcolor="#4F4D4D" scope="col">
    ...
    <th width="9%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_1.'('.$structure->final_value_1.')';?>
    </th>
    <th width="8%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_2.'('.$structure->final_value_2.')';?>
    </th>
    <th width="8%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_3.'('.$structure->final_value_3.')';?>
    </th>
    <th width="8%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_4.'('.$structure->final_value_4.')';?>
    </th>
    <th width="4%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_5.'('.$structure->final_value_5.')';?>
    </th>
    <th width="4%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_6.'('.$structure->final_value_6.')';?>
    </th>
    <th width="4%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php echo $structure->final_title_7.'('.$structure->final_value_7.')';?>
    </th>
       
    <th width="8%" align="center" valign="middle" bgcolor="#4F4D4D" scope="col">
        Total (<?php echo $total; ?>)
    </th>
    <th width="7%" align="center" valign="middle" bgcolor="#4F4D4D" scope="col">
        Grand Total (100)
    </th>
...
<tbody>
  ...
  <tr>
    ...
    <td align="center" valign="top" style="font-size: 10px"><?php echo $obtained1; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_1']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_2']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_3']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_4']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_5']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_6']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $row['final_value_7']; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $obtained2; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $obtained; ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo number_format("$percentage",2); ?></td>
    <td align="center" valign="top" style="font-size: 10px"><?php echo $grade; ?></td>
