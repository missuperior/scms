...
<table style="margin-left:300px; color:white; font-family: Arial; font-size: 14px; font-weight: normal" height="30" width="15%" border="4" cellspacing="0" cellpadding="0">
    <tr>
        <th width="15%" scope="col" bgcolor="#6B6565" >AWARD LIST </th>
    </tr>
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr style="height: 30px;">       
        ...
        <th width="35%" align="left" valign="middle"  scope="col"><?php  echo '  '.$students[0]['batch_type'].' '.$students[0]['batch'].'   ('.$students[0]['shift'],')'; ?></th>    
        <th width="30%" align="left" valign="middle"  scope="col"><b>Dated: </b>____________________</th>        
    </tr>
    
    <tr style="height: 30px;">             
     <th width="35%" align="left" valign="middle" scope="col"><b> Subject : </b>____________________</th>         
     <th width="35%" align="left" valign="middle"  scope="col"><b>T-Marks : </b>____________________</th>    
     <th width="30%" align="left" valign="middle"  scope="col"><b>Exam : </b>____________________</th>               
    </tr>
...
<table style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 11px; font-weight:bold; color: #000;" width="100%" border="1" cellspacing="0" cellpadding="0">
  <THEAD>
    ...
    <th width="9%" align="center" bgcolor="#4F4D4D" scope="col">
        Assign.
    </th>
    <th width="9%" align="center" bgcolor="#4F4D4D" scope="col">
        Quiz
...
<table style="margin-top:50px; width: 100%">
    <tr style="height: 35px;">
        <td style=" width: 60%">Date of Issue : _____________________ </td>
        <td style=" text-align: center;  width: 20%; border: 1px solid "><b>Pass Students</b></td>
        <td style=" width: 20%; border: 1px solid "></td>
    </tr>
    <tr style="height: 35px;" >
        <td style=" width: 60% ">Date of Return : ____________________ </td>
        <td style=" text-align: center;  width: 20%; border: 1px solid "><b>Fail Students</b></td>
        <td style=" width: 20%; border: 1px solid "></td>
    </tr>
    <tr style="height: 35px;" >
        <td style=" width: 60% ">Examiner: ________________________</td>
        <td style=" text-align: center; width: 20%; border: 1px solid "><b>Absent Students</b></td>
        <td style=" width: 20%; border: 1px solid "></td>
    </tr>
    <tr style="height: 35px;" >
        <td style=" width: 60% ">Signature : ________________________</td>
