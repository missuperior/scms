                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead>
                                           <tr style="font-size: 10px">
                                             <td colspan="5"><img width="60" src="<?php echo base_url();?>assets/avatars/challan_logo2.png" /><b style="  font-size: 20px;    margin-left: 10px;">Superior University Lahore</b></td>
