	...
	<body>
    	<div id="mainbackground">
    		<div id="wrapper">
                ...
                <p id="adminpara" style=" margin-left: 332px;">Examinations Login</p>
                <div id="overallbackground">
                <div id="wholemiddlearea">
                    <form name="adminLogin" id="adminLogin" method="post" onsubmit="return validate()"  action="<?php echo base_url() ?>examination_de/login">
                	<div id="loginarea">
                    	<div id="image">
