                                       ...
                                       <hr />
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url()?>courses/update_course" enctype="multipart/form-data" />
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="course_type" id="course_type">
                                                                <option    <?php echo $dd = $course[0]['course_type'] == 'Theory' ? 'selected="selected"':''; ?> value="Theory">Theory</option>
                                                                <option    <?php echo $dd = $course[0]['course_type'] == 'Lab' ? 'selected="selected"':''; ?> value="Lab">Lab</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
