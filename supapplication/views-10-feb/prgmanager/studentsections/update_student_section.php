                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="semester" id="offered_courses">
                                                                <?php 
                                                                  for($i=1; $i<=8 ;  $i++){
                                                                ?>
                                                                  <option value="<?php echo $i ; ?>" <?php if($allocated_course[0]['semester'] == $i ){ ?> <?php echo 'selected="selected"'; } ?> >
                                                                      Semester <?php echo $i; ?> 
                                                                  </option>
                                                                <?php  } ?>
                                                            </select>
                                                        ...
                                                        <div class="span12">
                                                            <select name="teacher[]" id="teacher">
                                                                <?php foreach($teachers as $o => $r){ ?>
                                                                    <option  <?php if($allocated_course[0]['teacher_id'] == $r['emp_id'] ){ ?> <?php echo 'selected="selected"'; } ?>  value="<?php echo $r['emp_id']; ?>"><?php echo $r['designation_title'].' <=> '.$r['employee_name'].' <=> '.$r['department_name']; ?> </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <input type="hidden" name="course_allocation_id" value="<?php echo $allocated_course[0]['course_allocation_id']; ?>" />
