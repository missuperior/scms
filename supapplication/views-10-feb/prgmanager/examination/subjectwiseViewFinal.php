                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead>
                                           ...
                                           <tr style="font-size: 10px">
                                             <td colspan="7"><img width="60" src="<?php echo base_url();?>assets/avatars/challan_logo.png" /><b style="  font-size: 20px;    margin-left: 10px;">Superior Group of Colleges</b></td>
                                               <td colspan="7"><h3 style="text-align:right">Subject Wise Result report</h3></td>
                                           </tr>
                                           
                                           <tr style="font-size: 10px">
                                               <td colspan="5"><b>Campus : <?php  echo $students[0]['campus_name']; ?></b></td>
                                               <td colspan="5"><b>Campaign : <?php echo $students[0]['session']; ?></b></td>
                                               <td colspan="4"><b>Semester : <?php  echo 'Semester 0'.$students[0]['semester']; ?></b></td>
                                           </tr>
                                           
                                           <tr style="font-size: 10px">
                                               <td colspan="5"><b>Program : <?php  echo $students[0]['program_name']; ?></b></td>
                                               <td colspan="5"><b>Subject : <?php echo $students[0]['course_name']; ?></b></td>
