...
<table style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 10px; color: #000;" width="100%" border="1" cellspacing="0" cellpadding="0">
  <THEAD>
...
<!--    <th width="3%" height="82" align="center" valign="top" bgcolor="#FFFFFF" scope="col">
    ...
    <th width="10%" align="center" valign="middle" bgcolor="#4F4D4D" scope="col">
    ...
    <th width="11%" align="center" valign="bottom" bgcolor="#4F4D4D" scope="col">
        <?php 
            $total_marks = $exam_type == 'Mid' ? '30' : '100';
...
<tbody>
  <tr>
    ...
    <td align="center" valign="top"><?php echo $students[$c]['student_name']; ?></td>
    ...
    <td align="center" valign="top">
        <?php 
            if($exam_type == 'Mid'){ 
                ...
                $res    = $this->Examination_model->calculateGpa($students[$i]['obtained'],30,$exam_type);
                $gpa    =   $gpa + $res; 
            }else{ 
    ...
    <td align="center" valign="top"><?php echo number_format("$cgpa",2);?></td>
    
    <td align="center" valign="top"><?php echo $totall_obtained;?></td>
    
    <td align="center" valign="top"><?php echo $totall;?></td>
...
<table style="margin-top:50px; width: 100%">
    <tr style="height: 35px;">
        ...
        <td style=" width: 40%">Checked  By: ___________________________ </td>
    </tr>
    <tr style="height: 35px;" >
        <td style=" width: 60% ">________________________________________ </td>
