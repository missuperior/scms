...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>							
                <a href="" style="text-decoration: none">Export Students Course Form</a>
            </li>						
        </ul><!--.breadcrumb-->
    ...
    <div class="page-content">
        <div class="page-header position-relative">
            <h1>Export Students Course Form</h1>
        </div><!--/.page-header-->
        <div class="row-fluid">
            <div class="span12">
                <!--PAGE CONTENT BEGINS-->
                ...
                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>advisor/student_list_export" enctype="multipart/form-data" target="_blank"/>
                <div class="row-fluid">
                    <div class="span12">  
                                ...
                                <div class="row-fluid">                                    
                                    <div class="table-header">
                                       <h3>Export Students Course Form</h3>
                                    </div>
