                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <form class="form-horizontal" id="inquiryform" method="POST" action="<?php echo base_url(); ?>admission/update_inquiry" enctype="multipart/form-data" />
                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            ...
                                                            <input style="width: 200px;" type="text" name="inquiry_no" id="inquiry_no" value="<?php echo $inquiry[0]['inquiry_no'];?>" class="span5" />
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="shift" id="shift" value="<?php echo $inquiry[0]['shift'];?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="campus" name="campus" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <?php foreach ($campus as $row) { ?>
                                                                    <option <?php if($inquiry[0]['campus_id'] == $row['campus_id']) echo 'selected="selected"'; else if(set_value('campus') == $row['campus_id']) echo '"selected=selected"'; ?> value="<?php echo $row['campus_id'] ?>"><?php echo $row['campus_name'] ?></option> 
<?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
