                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                            <form class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission/add_initial_form_data" enctype="multipart/form-data" />
...
<!--                                                <h3 style="margin-top: 20px" class="lighter block green">FORM INFORMATION</h3>   -->
                                                 <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input style="width: 188px;" type="text" name="form_no" id="form_no" value="<?php echo set_value('form_no'); ?>" style="width: 300px;" class="span10" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="date" id="date" value="<?php echo set_value('date'); ?>" style="width: 188px;" class="span10 date-picker" data-date-format="yyyy-mm-dd" />
 ...
 <script type="text/javascript">
            $('#initialform').validate({
                ...
                submitHandler: function(form) {
                    document.validationForm.action = "<?php echo base_url(); ?>admission/add_initial_form_data";
