                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Toppers Form</h4>                               
                            </div>
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>examination/class_topper_report" />
...
<?php } ?>																			
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    <div class="span12">
                                                      <select class="chzn-select" name="program" id="program" onchange="proSection(this.value);" data-placeholder="Choose a Program...">
                                                ...
                                                <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    <div class="span12">
                                                        <select name="section" id="section" onchange="getSubject();" data-placeholder="Choose Section...">
                                                ...
                                                <div style="width: 100%; float: left;margin-bottom: 15px" class="control-group">
                                                    <label style="width: 130px;  margin-left: 30px;" class="control-label" for="id-date-picker-1">No. of Students:</label>
                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                          <input style="width: 200px;" type="text" name="limit" id="limit" value="<?php echo set_value('limit'); ?>" placeholder="e.g: 5" />
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
  ...
  function getSubject()
  {
    ...
    $.ajax({
        ...
        url: "<?php echo base_url(); ?>examination/get_subjects",
