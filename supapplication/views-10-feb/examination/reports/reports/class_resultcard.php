...
<div style=" width:100%; float:left; margin-bottom: 30px;"  >
    ...
    <div style="width:100%; float:  left;">
        ...
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px; margin-right: 400px; font-weight: normal;"><?php echo $info[$i]['roll_no'];?></h3>
        
        <label style="float: left; width:200px; font-size: 18px; font-weight: bold;">REGISTRATION NO : </label>
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px;  margin-bottom: 20px; font-weight: normal;"><?php echo $info[$i]['reg_no'];?></h3>
        
        <label style="float: left; width:200px; font-size: 18px; font-weight: bold;">STUDENT NAME : </label>
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px; margin-right: 400px; font-weight: normal;"><?php echo $info[$i]['student_name'];?></h3>
                
        <label style="float: left; width:200px; font-size: 18px; font-weight: bold;">FATHER'S NAME : </label>
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px; margin-bottom: 20px; font-weight: normal;"><?php echo $info[$i]['father_name'];?></h3>
        
        <label style="float: left; width:200px; font-size: 18px; font-weight: bold;">SEMESTER : </label>
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px; margin-right: 400px; font-weight: normal;"><?php echo 'SEMESTER 0'.$info[$i]['semester'];?></h3>
        
        <label style="float: left; width:200px; font-size: 18px; font-weight: bold;">PROGRAM : </label>
        <h3 style="float: left;    font-size: 18px;    margin: 0;    width: 250px; margin-bottom: 20px; font-weight: normal;"><?php echo $info[$i]['program_name'];?></h3>
...
<table style=" width:100%; margin-top:20px; float:left;" class="table" >
            ...
            <tbody style="align:center; width:100%;">
		<th style=" width:60%; "><p style="text-align: left; font-size: 20px; font-weight: bold"><?php echo 'SEMESTER 0'.$info[$i]['semester'];?></p></th>
...
<table style="border-style: solid; border-width: 1px; width:100%; float:left;"  class="table">
    ...
    <?php 
            ...
            $result         =   $this->Examination_model->get_std_result($info[$i]['semester'],$info[$i]['reg_id']);
        ...
        ?>
        <tr>
                <td style="border-style: solid; border-width: 1px; width:9%; "><p style="text-align: center;"><?php echo $i+1; ?></p></td>
