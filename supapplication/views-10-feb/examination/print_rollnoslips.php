        ...
        <?php }?>
            ...
            <div id="wholemiddlearea">
                <div id="leftareaofwholemiddlearea">
                    ...
                    <div class="clr"></div>
                    <p class="texttypeone">THE SUPERIOR COLLEGE, LAHORE</p>
                    <div class="clr"></div>
                    <div class="labelandinput">
                    ...
                    <div class="clr"></div>
                    <div class="labelandinput">
                        <label class="texttypeone">His/Her registration number is</label><div class="border_bottom"><input type="text" value="<?php echo $row['reg_no']; ?>" style="width:135px; height:16px; background-color:transparent; margin-top:4px; border:none;" /></div>
                    </div>
                    <div class="clr"></div>                       
                </div>
                <div id="rightareaofwholemiddlearea">
                    <div id="picture_area">
                        <img style="border-radius:15px" width="130px" height="150" src="<?php echo base_url();?>user_images/<?php echo $row['image']; ?>"/>
                    </div>
                </div>
                <div class="clr"></div>
            </div>
