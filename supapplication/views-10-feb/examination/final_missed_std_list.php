                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <form name="postChallan" id="postChallan" onsubmit="return confirm('Are you sure ?');" action="<?php echo  base_url()?>examination/add_final_missed_result" method="post" enctype="multipart/form-data">
                                    <table id="example-" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>                                        
                                             ...
                                             <tr style="font-size: 10px">
                                                            ...
                                                            <td>
                                                                   <?php echo $i+1; ?>
                                                                   <input type="hidden" id="reg_id" name="student_id" value="<?php echo $student_id; ?>" />
                                                            ...
                                                            <td><input style="width:50px" name="o_marks1" type="text"  id="a<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks2" type="text"   id="b<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks3" type="text"  id="c<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks4" type="text"  id="d<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks5" type="text"   id="e<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks6" type="text"   id="f<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input style="width:50px" name="o_marks7" type="text"   id="g<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
