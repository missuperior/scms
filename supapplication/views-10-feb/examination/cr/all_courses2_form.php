                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                ...
                                <form target="_blank" class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>examination/add_view_result_cr" enctype="multipart/form-data" />
