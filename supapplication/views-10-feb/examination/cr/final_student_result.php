            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    <?php 
                                    $final_result     =   $this->Teachers_model->getFinalResult($students[0]['student_id'],$session_id,$course_id,$program_id,$batch_id,$section_id);
                                    if(count($final_result) > 0 ){?>                                    
                                    <div class="table-header">                                        
                                        <?php if($res_status == 1){?>
                                            <h3 style="width:70%; float:left; margin: 0px;" id="title">Final Result </h3> 
                                            <h3 >
                                                 <a onclick="return confirm('Are You Sure ?');" style="text-decoration: none; color: white"  href="<?php echo base_url();?>examination/delete_final_result_cr/<?php echo $program_id;?>/<?php echo $course_id;?>/<?php echo $section_id;?>/<?php echo $session_id;?>/<?php echo $batch_id;?>">
                                                    Delete 
                                                </a>  

                                                <a onclick="return confirm('Are You Sure ?');" style="text-decoration: none; color: white"  href="<?php echo base_url();?>examination/edit_final_result_cr/<?php echo $program_id;?>/<?php echo $course_id;?>/<?php echo $section_id;?>/<?php echo $session_id;?>/<?php echo $batch_id;?>">
                                                    / Edit
                                                </a>                                                                                          
                                            </h3>  
                                            <?php }else{?>
                                                <h3 id="title">Final Result </h3>     
                                            <?php } ?>
