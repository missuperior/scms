                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">EDIT PROGRAM FEE INFORMATION</h4>                               
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                            <form class="form-horizontal" id="programfeeform" method="POST" action="<?php echo  base_url()?>admin/update_program_fee" enctype="multipart/form-data" />
                            
                            <input type="hidden" name="program_fee_id" value="<?php echo $program_fee[0]['program_fee_id']; ?>" />
...
<!--                                                <h3 style="margin-top: 20px" class="lighter block green">FORM INFORMATION</h3>   -->
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 188px;" id="program" name="program" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <option <?php if($program_fee[0]['program_id'] == $row['program_id']) echo 'selected="selected"'; ?> value="<?php echo $row['program_id']?>"><?php echo $row['program_name']?></option> 
                                                                <?php }?>																					
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <select style="width: 188px;" id="campus" name="campus" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <option <?php if($program_fee[0]['campus_id'] == $row['campus_id']) echo 'selected="selected"'; ?> value="<?php echo $row['campus_id']?>"><?php echo $row['campus_name']?></option> 
                                                                <?php }?>																					
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="span12">
                                                             <select style="width: 188px;" id="campaign" name="campaign" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <?php foreach ($campaign as $row) { ?>
                                                                    <option <?php if($program_fee[0]['campaign_id'] == $row['campaign_id']) echo 'selected="selected"'; ?> value="<?php echo $row['campaign_id'] ?>"><?php echo $row['campaign_name'] ?></option> <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="no_of_sessions" id="no_of_sessions" value="<?php echo $program_fee[0]['no_of_sessions'];?>" style="width: 188px;" class="span10" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="admission_fee" id="admission_fee" value="<?php echo $program_fee[0]['admission_fee'];?>" style="width: 188px;" class="span10" />
                                                        </div>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="session_fee" id="session_fee" value="<?php echo $program_fee[0]['session_fee'];?>" style="width: 188px;" class="span10" />
                                                        </div>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="misc_fee" id="misc_fee" value="<?php echo $program_fee[0]['misc_fee'];?>" style="width: 188px;" class="span10" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                             <select style="width: 188px;" id="type" name="type" class="select2" data-placeholder="Click to Choose...">                                                               
                                                                 <option <?php if($program_fee[0]['type'] == 'Semester') echo 'selected= "selected"';?> value="Semester">Semester</option>
                                                                 <option  <?php if($program_fee[0]['type'] == 'Annual') echo 'selected= "selected"';?> value="Annual">Annual</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
...
<!--                                                <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            <input type="text" name="year_date" id="year_date" value="<?php echo $program_fee[0]['year_date'];?>" style="width: 188px;" class="span10 date-picker" data-date-format="yyyy-mm-dd" />
