                                       ...
                                       <hr />
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <form class="form-horizontal" id="campusform" method="POST" action="<?php echo base_url()?>admin/add_campus" enctype="multipart/form-data" />
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="campus_name" id="campus_name" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <input style="width: 200px;" type="text" name="campus_code" id="campus_code" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
