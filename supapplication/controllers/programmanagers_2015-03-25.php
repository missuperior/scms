...
//            $cur_session_id  = $current_session[0]['session_id']; 
        ...
        public function ajax_section_batch_teachser(){
            ...
            $i = 0;
            $test.='<table id="sample-table-2" class="table table-striped table-bordered table-hover"><tr><td><label  class="checkbox" style="width: 100%;">Sr#</label></td><td>Name</td><td>Designation</td><td>Course</td><td>Section</td></tr>';
            
            foreach( $result as  $pp){ 
                $test.='<tr><td><label  class="checkbox" style="width: 100%;"></label></td><td>'.$pp["employee_name"].'</td><td>'.$pp["designation_title"].'</td><td>'.$pp["course_name"].'</td><td>'.$pp["course_section"].'</td></tr>';
                $i++; 
            } 
            $test.='</tbody></table>';
            echo $test;exit;
