...
//    *****************                Entry Test Module              ***************
         ...
         // get students info room wise for entry test
            ...
            public function award_list_form()
            {
                ...
                $result['rooms']              = $this->Manager_model->getAllrooms();
                $result['tests']              = $this->Manager_model->getOpentests();                
            ...
            public function award_list()
            {
                ...
                $result['programslist']     =   $this->Manager_model->getAllocatedProg($room_id,$tes_id);
