...
//          echo '<pre>';print_r($res['packageInfo'][0]);die;
...
// print challan for installment
      ...
      $this->login_check();
           ...
           if($result['std_package'][0]['campaign_id'] == 1 && $result['challan_info'][0]['session'] == 'Fall 2015'){
               $session     =   'Semester 3';
            ...
            $this->load->view('admin_ace/admin_footer');
             ...
             //   echo '<pre>'; var_dump($result);die;
                ...
                foreach($result AS $row){
                                ...
                                // For MBBS
                                if($program_id == 53){
                                    $tax            =   5*$row['session_fee']/100;
                                    $fee            = $row['session_fee']+$tax;
                                }else{                                    
