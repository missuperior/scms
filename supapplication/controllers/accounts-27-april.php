...
class Accounts extends CI_Controller {
  ...
  public function dashboard() {
    ...
    $result['campaign']                 =   $res['campaign_data'][0]['campaign_name'];        
...
//                            print_r($installment_data);die;
         ...
         public function edit_installments()
        {
           ...
           $active_session_id           =   $this->Admin_model->getActiveSessionId();
           
           
           
           $result['std_info']          =    $this->Accounts_model->getStudentPackageInfo($_GET['student_id']);
           $res['packageInfo']          =    $this->Accounts_model->getPackageInfo($_GET['student_id']);
           $result['std_installments']  =    $this->Accounts_model->getStudentInstallments2($_GET['student_id'],$active_session_id);
        ...
        public function change_due_date()
                {
                  ...
                  $res = $this->Accounts_model->changeDueDate($campus_id, $program_id,  $start_date, $end_date);
    ...
    public function promote_students(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('admin_ace/admin_footer');
                ...
                $result          =   $this->Accounts_model->promoteStudents($program_id,$pre_session);
