...
//      echo '<pre>';            print_r($programs);die;
  ...
  public function set_roll_no_duplication_os() {


        $campuses = $this->Test_model->getCampus_os();
        //echo '<pre>';            print_r($campuses);die;

        foreach ($campuses AS $camp) {
            $programs = $this->Test_model->getPrograms_os($camp['campus_id']);

            foreach ($programs AS $row) {
                $students = $this->Test_model->getStudents_os($row['program_id'],$camp['campus_id']);
                ...
                foreach ($students AS $roww) {
                            ...
                            $result = $this->Test_model->updateSerial_os($roww['student_id'], $roww['roll_no'], $serial);
                }
                // die;
            }
        }die;
