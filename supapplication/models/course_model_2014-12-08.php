...
/* added by zohaib*/
    ...
    function checkAlreadyCourseExist($course_name , $course_code , $course_type, $credit_hours )
    {
        $query      = "SELECT * FROM courses WHERE course_name='$course_name' AND course_code='$course_code' AND course_type='$course_type' AND credit_hours='$credit_hours'";
        $query_data = $this->db->query($query);
        return $query_data->result_array();
    ...
    function courseAlreadyOffer($course_id, $session_id)
    {
        $query      = "SELECT * FROM  offered_courses WHERE course_id='$course_id' AND session_id='$session_id' ";
        $query_data = $this->db->query($query);
    ...
    function cursessionofferedcourses($prg_mng_id , $cur_session_id)
    {
