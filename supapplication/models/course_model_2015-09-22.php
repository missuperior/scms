...
/* added by zohaib*/
    ...
    function allocatedCourseSectionsSettings($cur_session_id , $emp_id , $batch_id , $program_id){
          $query      = "
                        ...
                        WHERE course_sections_settings.session_id='$cur_session_id' AND course_sections_settings.batch_id = $batch_id AND course_sections_settings.advisor_id = $emp_id AND course_sections_settings.program_id = $program_id";
