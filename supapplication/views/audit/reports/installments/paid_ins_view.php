                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">PAID Installments Report</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>  
                                          ...
                                          foreach($ins_report AS $key => $row){
                                            ...
                                            <?php 
                                                $instllments    =   $this->Account_reports_model->getPaidInstallments($row['student_id'],$session_id,$campus_id);
                                            ...
                                            <td><?php if($instllments[$j]['post_date'] != ''){echo $instllments[$j]['post_date']; }else{echo '';}?></td>
                                            <?php }?>                                            
