                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Reference Wise Prospectus Report</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="5"><h2 style="text-align:left; font-size:20px">Reference Wise Prospectus Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                               ...
                                               <td colspan="3"><b>Campus : <?php  if($campus_id == 0) { echo 'All';}else{ echo $prospectus_report[0]['campus_name'];}?></b></td>
                                                ...
                                                <td colspan="3"><b style="font-size: 12px; color: #553333">Reference : <?php if($reference == 0){echo 'All';}else{ echo $prospectus_report[0]['reference_source']; }?></b></td>
                                        ...
                                        <tr style="font-size: 10px">
                                               ...
                                               <td colspan="7"><b><?php echo 'Grand Total'; ?></b></td>
                                               <td colspan="3"><b><?php echo $quantity; ?></b></td>
