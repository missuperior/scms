                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Campus Wise Prospectus Report</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="6"><h2 style="text-align:left; font-size:23px">Campus Wise Prospectus Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                                
                                               <td colspan="4"><b>Campus : <?php  if($campus_id == 0) { echo 'All';}else{ echo $prospectus_report[0]['campus_name'];}?></b></td>
                                                <td colspan="4"><b>Campaign : <?php echo $prospectus_report[0]['campaign_name']; ?></b></td>
