                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">         
                                    ...
                                    <div class="table-header">
                                        ...
                                        <h3 id="title">Prospectus Summary (User) Report</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                         <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="2"><h2 style="text-align:left">Prospectus Summary (User) Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                                
                                               <td colspan="2"><b>Campus : <?php if($campus_id == 0){echo 'All'.' (<b style="font-size: 10px; color: #553333">Prospectus</b>)';}else{echo $prospectus_report[0]['campus_name'].' (<b style="font-size: 10px; color: #553333">Prospectus</b>)';} ?></b></td>
                                                <td><b>Campaign : <?php echo $prospectus_report[0]['campaign_name']; ?></b></td>
<!--                                                <td><b style="font-size: 12px; color: #553333">Inquiry Type : <?php echo $prospectus_report[0]['inquiry_type']; ?></b></td>-->
                                        ...
                                        for($i=0; $i<count($prospectus_report);$i++){ 
                                            $total      = $total    + $prospectus_report[$i]['total'];
                                            ?>
                                            <tr style="font-size: 10px">
                                               ...
                                               <td><?php echo $prospectus_report[$i]['total']; ?></td>                                                                                                
