                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="6"><h2 style="text-align:right">Inquiry Summary (Program)</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">
                                                
                                               <td colspan="4"><b>Campus : <?php echo $inquiry_report[0]['campus_name']; ?></b></td>
...
<!--                                                <td><?php echo $inquiry_report[$i]['user_name']; ?></td>-->
                                    ...
                                    <tr><td>Powered By : Superior Solutions</td></tr>
