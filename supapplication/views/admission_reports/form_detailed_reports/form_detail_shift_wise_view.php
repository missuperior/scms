                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">     
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">Detail Shift Form Report</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="4"><h2 style="font-size: 20px">Shift Wise Detail Report</h2></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">                                                
                                               <td colspan="3"><b>Shift : <?php echo $detail_from_report[0]['shift']; ?></b></td>
