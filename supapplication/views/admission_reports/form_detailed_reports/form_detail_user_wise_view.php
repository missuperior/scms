                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">     
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">Detail Form User Report</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="4"><h2 style="font-size: 20px">Detail Form User Wise Report</h2></td>
                                           </tr>
                                           <tr style="font-size: 10px">                                                
                                               <td colspan="3"><b>User / Operator : <?php echo $detail_from_report[0]['sub_login']; ?></b></td>
                                        ...
                                        for($i=0; $i<count($detail_from_report);$i++){  ?>
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $detail_from_report[$i]['program_name']; ?></td>
