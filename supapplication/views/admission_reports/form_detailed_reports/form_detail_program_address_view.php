                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                                ...
                                                <td colspan="5"><h2 style="font-size: 20px">Program Address Wise Detail Report</h2></td>
                                           </tr>
                                           <tr style="font-size: 10px">                                                
                                                ...
                                                <td colspan="2"><b>Program : <?php if($program_id == 0){ echo 'All';}else{ echo $detail_from_report[0]['program_name'];} ?></b></td>
                                        ...
                                        for($i=0; $i<count($detail_from_report);$i++){  ?>
                                            <tr style="font-size: 10px">
                                                ...
                                                <td><?php echo $detail_from_report[$i]['present_address']; ?></td>
                                                <td><?php echo $detail_from_report[$i]['email']; ?></td>
                                                <td><?php echo $detail_from_report[$i]['city_name']; ?></td>
                                                <td><?php  echo $detail_from_report[$i]['guardian_phone'];?></td>
                                           </tr>                                            
                                            <?php } ?>                                            
                                        </tbody>
