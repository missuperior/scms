                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Shift Wise Report Form</h4>                               
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/shift_wise_report_initial" enctype="multipart/form-data" />
...
<?php } ?>																			
                                                ...
                                                <div class="control-group">
                                                 ...
                                                 <select style="width: 200px;" id="shift" name="shift" class="select2" data-placeholder="Click to Choose...">
                                                                ...
                                                                <option value="Morning" <?php if (set_value('Initial_type') == 'Morning') echo '"selected=selected"'; ?> />Morning
                                                                <option value="Evening" <?php if (set_value('Initial_type') == 'Evening') echo '"selected=selected"'; ?> />Evening																				
                                                                <option value="Weekend" <?php if (set_value('Initial_type') == 'Weekend') echo '"selected=selected"'; ?> />Weekend																				
                                                                <option value="0" <?php if (set_value('Initial_type') == 0) echo '"selected=selected"'; ?> />All																				
                                                            </select>
                                                        </div>
                                                    </div>
                                                  </div>
