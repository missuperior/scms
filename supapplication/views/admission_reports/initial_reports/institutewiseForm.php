                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">Institute Wise Report Form</h4>                               
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>admission_reports/institute_wise_report_initial" enctype="multipart/form-data" />
                                            ...
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                          <select onchange="getInfo(this.value)" style="width: 200px;" id="city" name="city" class="select2" data-placeholder="Click to Choose...">
  ...
  function getInfo(value)
        {
            ...
            if(value!=""){
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>admission_reports/get_institute_info",
