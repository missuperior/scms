...
<table  width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr style="height: 30px; color: white ">    
    <th width="30%" align="center" valign="middle" bgcolor="#6B6565" scope="col"> <?php  echo '  '.$students[0]['campus_name']; ?></th>
    <th width="25%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><?php  echo '  '.$students[0]['program_name']; ?></th>
    <th width="25%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><?php  echo '  '.$students[0]['batch_type'].' '.$students[0]['batch']; ?></th>    
    <th width="20%" align="center" valign="middle" bgcolor="#6B6565" scope="col"><b>Exam Type : &nbsp;&nbsp;</b> <?php  echo 'Mid'; ?></th>
...
<tbody>
  <tr>
    ...
    <td align="center" valign="top" style="font-size: 10px"><?php echo number_format("$gpaa",2);?></td>
