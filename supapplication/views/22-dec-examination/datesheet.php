...
<div style="margin-top:25px;">
  ...
  <div class="center_text">
    ...
    <h3 style="font-size:26px; margin-left: 45px"><?php echo $row['campus_name'];?> </h3>
    <br />
  ...
  <div style="text-align:center; margin-bottom: 15px; margin-top: 20px;" >
    ...
    <br/>
    <h4 style="font-size:26px;"><?php echo $row['campus_name'];?>  </h4>    
  </div>
  ...
  <table width="900" height="170" border="1" cellpadding="0" cellspacing="0">
        ...
        <?php 
       // echo '<Pre>'; var_dump($datesheet);die;
        foreach($datesheet AS $row2){?>
          <tr>
              <td align="center" valign="center"><?php echo  $row2['course_name'];?></td>
              <td align="center" valign="center"><?php echo $row2['day'];?></td>
              <td align="center" valign="center"><?php echo date('d-M-y',  strtotime($row2['date']));?></td>
        <td align="center" valign="center"><?php echo date('H:i',  strtotime($row2['start_time'])).' - '.date('H:i',  strtotime($row2['end_time']));?></td>   
          </tr>
        <?php }?>
  ...
  <h3>  2. Unfair Means Case will be registered against the candidate who refuses
            to obey Center Superintendent / Invigilator, changes his/ her Roll No 
            /Seat with another candidate, creates Disturbance, stages walkout or 
            otherwise misbehaves in or around the Examination Hall.
  </h3>
  <div class="clr10" style="margin-bottom:15px;"></div>
  <h3>  3. Unfair Means Case will also be registered against the candidate who
        violates the instructions and Rules & Regulations of the University.</h3>
  <div class="clr10" style="margin-bottom:15px;"></div>
  <h3>  4.  No one is allowed to leave the Examination Hall before first one hour is
            over or before half the time is over, candidate shall not be allowed to 
            take away the question paper.</h3>
  <div class="clr10" style="margin-bottom:15px;"></div>
