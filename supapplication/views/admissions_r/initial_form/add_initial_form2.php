                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            ...
                                                            <input type="hidden" name="campaign_id" id="campaign_id" value="<?php echo $inquiry[0]['campaign_id'];?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 50%; float: left;margin-bottom: 25px;" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            ...
                                                            <input style="width: 200px;" type="text" name="mobile" id="mobile" value="<?php echo $inquiry[0]['contact'];?>" class="span5" placeholder="e.g 0321-1234567" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="span12">
                                                            <select style="width: 200px;" id="campus" name="campus" class="chzn-select" data-placeholder="Click to Choose...">
                                                                ...
                                                                <?php foreach ($campus as $row) { ?>
                                                                    <option <?php if ($inquiry[0]['campus_id'] == $row['campus_id']){ echo 'selected="selected"';}else if($this->session->userdata('campus_id') == $row['campus_id']){echo 'selected="selected"';} ?> value="<?php echo $row['campus_id'] ?>"><?php echo $row['campus_name'] ?></option> 
<?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
