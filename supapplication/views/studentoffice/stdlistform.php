                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">                                  
                                    <div class="row-fluid">
                                        <form target="_blank" class="form-horizontal" id="initialform" method="POST" action="<?php echo  base_url()?>studentoffice/student_list" enctype="multipart/form-data" />
                                                ...
                                                <div style="width: 100%;margin-bottom: 25px; float: left" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12" id="prog">
                                                            <select  onchange="getRollNoList(this.value);" style="width: 200px;" id="program" name="program" class="chzn-select" data-placeholder="Click to Choose...">
   ...
   function getProgram(value)
   {
       if(value!=""){
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>studentoffice/get_program_info",
        ...
        function getRollNoList(program_id)
              {                        
                  ...
                  if(program_id!=""){
                           $.ajax({
                               ...
                               url: "<?php echo base_url();?>studentoffice/get_RollNo_list",
