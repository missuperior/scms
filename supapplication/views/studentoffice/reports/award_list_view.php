                    ...
                    <div class="span12">
                            <div class="row-fluid">
                                    ...
                                    <div class="table-header">
                                        <h3 id="title">AWARD LIST</h3>
                                    </div>
                                
                                    <a  href="<?php echo base_url(); ?>examination/award_list_print/<?php echo $campaign_id;?>/<?php echo $program_id;?>">
                                        ...
                                        <thead>
                                           <tr style="font-size: 10px">
                                             <td colspan="3"><img width="60" src="<?php echo base_url();?>assets/avatars/challan_logo2.png" /><b style="  font-size: 20px;    margin-left: 10px;">Superior University Lahore</b></td>
                                               <td colspan="3"><h3 style="text-align:left">Award List</h3></td>
                                           </tr>
                                           <tr style="font-size: 10px">
