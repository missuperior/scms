    ...
    <?php 
           ...
           // echo '<pre>';print_r($result);die;
            foreach($result AS $row){
                    ...
                    $res    = $this->Examination_model->calculateGpa($obtained,$row['credit_hours']);
                    $gpa    =   $gpa + $res;
...
<tbody style="align:center; width:100%;">
		...
		<th style=" width:20%; "><p style="text-align: center; font-size:12px; ">GPA : <?php echo ' '.round($gpa/$total_credit_hours,2); ?></p></th>
...
<table style=" width:100%; float:left; margin-top: 20px;" class="table" >   
    <tbody style="align:center; width:100%;  font-size: 11px; font-weight: normal;">
                    ...
                    <th style="width:15%; "><p style="text-align: left; "><b>CGPA : </b><?php echo ' '.round($cgpa/$g_total_credit_hours,2); ?></p></th>                                        
    </tbody>
</table>
...
<div style=" width:100%"  >
    <div style="margin-top: 20px;">
        ...
        <div style=" width:35%; float: left;  "><p style="text-align: left">_____________________________</p></div>
    </div>
    <div>
