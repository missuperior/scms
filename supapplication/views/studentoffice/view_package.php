                                ...
                                <div>
                                    ...
                                    <div class="table-header">                                      
                                       <h3>Student Package Info
                                            <a style="margin-left: 500px; color:#fff; font-size: 18px; text-decoration: none" href="<?php echo base_url()?>studentoffice/view_form_student_info/<?php echo $std_package[0]['student_id']; ?>">
                                                 Change Program
                                            </a> |                                           
                                            <a style="color:#fff; font-size: 18px; text-decoration: none"   href="<?php echo site_url(); ?>studentoffice/edit_studentform/?student_id=<?php echo $std_package[0]['student_id'];?>">
                                                 Edit
                                            </a> 
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                                                                        
                                                <th>Form No</th>
                                                <td><?php echo $std_package[0]['form_no'];?></td>                                        
                                            </tr>
