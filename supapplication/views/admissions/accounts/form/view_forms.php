                                        ...
                                        <tbody>
                                         <?php
                                            ...
                                            <tr>                                                                                        
                                               ...
                                               <?php if($row['admission_stage'] == 2)
                                                    {
                                                ?>      
                                                     
                                                <?php if($result == 0){?>
                                                <a class="green" href="<?php echo base_url()?>accounts_de/student_package/?student_id=<?php echo $row['student_id']; ?>">
                                                            Add Package
                                                </a>
                                                <?php }else {?>
                                                
                                                 <a class="green" href="<?php echo base_url()?>accounts_de/view_package/?student_id=<?php echo $row['student_id']; ?>">
                                                            View Package
                                                </a>
