              ...
              <div class="widget-body">
                <div class="widget-main">
                  ...
                  <div class="row-fluid">
                    ...
                    <form class="form-horizontal" id="studentform" method="POST" action="<?php echo base_url(); ?>admission/update_studentform" enctype="multipart/form-data" />
                      ...
                      <div class="step-pane active" id="step1">
                        ...
                        <div style="width: 50%; float: left;margin-bottom: 15px;" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <input style="width: 200px;" type="text" name="form_no" id="form_no" value="<?php if(set_value('form_no')) {echo set_value('form_no');}else {echo $student[0]['form_no'];}?>" class="span6" />
                        ...
                        <div style="width: 50%; float: left;margin-bottom: 15px;" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <input style="width: 200px;" type="text" name="roll_no" id="roll_no"  value="<?php if(set_value('roll_no')) {echo set_value('roll_no');}else {echo $student[0]['roll_no'];}?>" class="span6" />
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="span12">
                              <select style="width: 201px;" id="current_session" name="current_session" class="select2" data-placeholder="Click to Choose...">
                                ...
                                <?php foreach ($sessions as $row) { ?>
                                  <option <?php if (set_value('current_session') == $row['session_id']){echo 'selected="selected"';}  if($student[0]['current_session_id'] == $row['session_id']) {echo 'selected="selected"';} ?>  value="<?php echo $row['session_id'] ?>"><?php echo $row['session'] ?></option> 
                                <?php } ?>																				
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="enrolment_session" name="enrolment_session" class="select2" data-placeholder="Click to Choose...">
                                <option value="">-- Select Session --</option>
                                <?php foreach ($sessions as $row) { ?>
                                  <option <?php if (set_value('enrolment_session') == $row['session_id']){ echo 'selected="selected"';} if($student[0]['enrolled_session_id'] == $row['session_id']) {echo 'selected="selected"';} ?> 
                                      value="<?php echo $row['session_id'] ?>"><?php echo $row['session'] ?></option> 
                                <?php } ?>																			
                              </select>
                            </div>
                          </div>
                        ...
                        <div style="width: 50%;margin-bottom: 15px; float: left" class="control-group">
                          <label style="width: 130px;" class="control-label" for="email">Section: <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>

                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="shift" name="shift" class="select2" data-placeholder="Click to Choose...">
                                <option value="">-- Select Shift --</option>
                                                                <option <?php if($student[0]['shift'] == "Morning") echo 'selected="selected"'; ?> value="Morning">Morning</option>
                                                                <option <?php if($student[0]['shift'] == "Evening") echo 'selected="selected"'; ?> value="Evening">Evening</option>
                                                                <option <?php if($student[0]['shift'] == "Weekend") echo 'selected="selected"'; ?> value="Weekend">Weekend</option>																		
                              </select>
                            </div>
                          </div>
                        </div>
                              ...
                              <select style="width: 201px;" id="batch" name="batch" class="select2" data-placeholder="Click to Choose...">
                                <option value="">-- Select Batch --</option> 
                                  <?php foreach ($batches as $row) { ?>
                                        <option <?php if (set_value('batch') == $row['batch_id']){echo 'selected="selected"';} if($student[0]['batch_id'] == $row['batch_id']) {echo 'selected="selected"';} ?>
                              ...
                              <select style="width: 201px;" id="program" name="program" class="select2" data-placeholder="Click to Choose...">
                                <option value="">-- Select Program --</option>
                                  <?php foreach ($programs as $row) { ?>
                                      <option <?php if (set_value('program') == $row['program_id']){echo 'selected="selected"';} if($student[0]['program_id'] == $row['program_id']) {echo 'selected="selected"';}  ?>
                        ...
                        <div style="width: 50%; float: left;margin-bottom: 15px" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <input style="width: 200px;" type="text" name="religion" id="religion" value="<?php if(set_value('religion')) {echo set_value('religion');}else {echo $student[0]['religion'];}?>" class="span6" />
                            </div>
                          </div>
                        </div>
                        <div style="width: 50%; float: left;margin-bottom: 15px" class="control-group">
...
<?php } ?>																				
                        ...
                        <div style="width: 50%; float: left;margin-bottom: 15px" class="control-group">
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <input style="width: 200px;"  type="text"name="kinship_rollno" id="kinship_rollno" value="<?php if(set_value('kinship_rollno')) {echo set_value('kinship_rollno');}elseif($student[0]['kinship_rollno'] != 0) {echo $student[0]['kinship_rollno'];}?>" class="span6" />
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="previous_subject" name="previous_subject" class="select2" data-placeholder="Click to Choose...">
                                ...
                                <option <?php if (set_value('previous_subject') == 1) {echo 'selected="selected"'; }if($student[0]['previous_subjects'] == 1) {echo 'selected="selected"';}  ?>
                                    value="1" />Science
                                <option <?php if (set_value('previous_subject') == 2) {echo 'selected="selected"'; }if($student[0]['previous_subjects'] == 2) {echo 'selected="selected"';}  ?>
                                    value="2" />Arts
                                <option <?php if (set_value('previous_subject') == 3) {echo 'selected="selected"'; }if($student[0]['previous_subjects'] == 3) {echo 'selected="selected"';}  ?>
                                    value="3" />Social																		                                                                																			
                                <option <?php if (set_value('previous_subject') == 4) {echo 'selected="selected"'; }if($student[0]['previous_subjects'] == 4) {echo 'selected="selected"';}  ?>
                                    value="4" />N/A																		                                                                																			
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="previous_grade" name="previous_grade" class="select2" data-placeholder="Click to Choose...">
                                ...
                                <option <?php if (set_value('previous_grade') == 1) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 1) {echo 'selected="selected"';}  ?>
                                
                                    value="1" />A
                               <option <?php if (set_value('previous_grade') == 2) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 2) {echo 'selected="selected"';}  ?>
                                value="2" />B
                               <option <?php if (set_value('previous_grade') == 3) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 3) {echo 'selected="selected"';}  ?> 
                               value="3" />C																				
                               <option <?php if (set_value('previous_grade') == 4) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 4) {echo 'selected="selected"';}  ?>
                               value="4" />D																				
                               <option <?php if (set_value('previous_grade') == 5) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 5) {echo 'selected="selected"';}  ?>
                               value="5" />E																				
                               <option <?php if (set_value('previous_grade') == 6) {echo 'selected="selected"';} if($student[0]['previous_grade'] == 6) {echo 'selected="selected"';}  ?>
                               value="6" />N/A																				
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                              <select style="width: 201px;" id="previous_year" name="previous_year" class="select2" data-placeholder="Click to Choose...">
                                ...
                                <option <?php if (set_value('previous_year') == 1) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 1) {echo 'selected="selected"';}  ?>
                                value="1" />2006
                                <option <?php if (set_value('previous_year') == 2) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 2) {echo 'selected="selected"';}  ?>
                                value="2" />2007
                                <option <?php if (set_value('previous_year') == 3) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 3) {echo 'selected="selected"';}  ?>
                                value="3" />2008
                                <option <?php if (set_value('previous_year') == 4) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 4) {echo 'selected="selected"';}  ?>
                                value="4" />2009
                                <option <?php if (set_value('previous_year') == 5) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 5) {echo 'selected="selected"';}  ?>
                                value="5" />2010
                                <option <?php if (set_value('previous_year') == 6) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 6) {echo 'selected="selected"';}  ?>
                                value="6" />2011
                                
                                <option <?php if (set_value('previous_year') == 7) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 7) {echo 'selected="selected"';}  ?>
                                value="7" />2012
                                <option <?php if (set_value('previous_year') == 8) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 8) {echo 'selected="selected"';}  ?>
                                value="8" />2013
                                <option <?php if (set_value('previous_year') == 9) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 9) {echo 'selected="selected"';}  ?>
                                value="9" />2014
                                <option <?php if (set_value('previous_year') == 10) {echo 'selected="selected"';} if($student[0]['previous_degree_year'] == 10) {echo 'selected="selected"';}  ?>
                                value="10" />2015
