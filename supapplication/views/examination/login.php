			...
			<!--wholemiddlearea starts from here-->
            	<div id="contentarea">
					...
					<div class="clr"></div>
                                      ...
                                      <form name="adminLogin" id="adminLogin" method="post" onsubmit="return validate()"  action="<?php echo base_url() ?>examination/admin_login">
						...
						<div class="textandinputfield">
							<input id="password" type="password" name="password" placeholder="password"/>
                                                        <input type="hidden" name="account_role_id" id="account_role_id" value="7" class="inputfield2" />
