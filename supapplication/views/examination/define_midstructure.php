            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>examination/define_mid_structure" enctype="multipart/form-data" />

                                                <!--<h3 style="margin-left: 185px; color: #006E6F"> Mid Total Marks : 30 </h3>-->
