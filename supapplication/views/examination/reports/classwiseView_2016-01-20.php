                    ...
                    <div class="span12">
                            <div class="row-fluid">
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php 
                                        $id = 0;
                                        //echo '<pre>';var_dump($students);echo '</pre>';die;
...
//                                                                    
//                                                                    $curobt += 
                                                                    $curcredit += $students[$i]['credit_hours'];
                                                                    
                                                                    $curtt += $totall_obtained *$students[0]['credit_hours'];
                                                                    
                                                                    $t_marks            = $students[$i]['obtained1']+$students[$i]['obtained2'];
                                                                    //echo $totall_obtained.'<ssss<br/>';
                                                                    //echo $totall_obtained.'<ssss<br/>';
                                                                    
                                                                    if($t_marks < 50 ){ 
                                                                        echo $t_marks.' (F)'; $marks++;
                                            ...
                                            <td><?php if($marks > 0){echo 'Fail';}else{
                                                echo '-- '.$curtt .'/'. $curcredit;  
                                                echo  '<br/>';
                                                $curgpa = $curtt .'/'. $curcredit;  
                                                echo number_format("$curgpa",2);
//                                                echo 'T Marks==>'. $t_marks.'<br/>' ;
//                                                echo 'GPA==>'. $gpa.'<br/>' ;
//                                                echo 'Count==>'. $count.'<br/>';
