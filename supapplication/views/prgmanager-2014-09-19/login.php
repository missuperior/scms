	 ...
	 <body>
                ...
                <div id="outercontentarea">
                	<div id="contentarea">
                            ...
                            <form name="adminLogin" id="adminLogin" method="post" onsubmit="return validate()"  action="<?php echo base_url() ?>programmanagers/admin_login">
                		<div id="loginarea">
                        			...
                        			<div id="labeltwodiv">
                        				<label class="labeltwo">PASSWORD</label>
                                                        ...
                                                        <input type="hidden" name="account_role_id" id="account_role_id" value="6" class="inputfield2" />
