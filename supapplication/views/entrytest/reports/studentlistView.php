                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <div class="table-header">                                        
                                        <h3 id="title">Students List Room Wise</h3>                                       
                                    </div>                                                                    
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        <thead> 
                                           <tr style="font-size: 10px">                                               
                                               <td colspan="3"><b style="  font-size: 22px;    margin-left: 10px;"><?php echo $programslist[0]['room_name'];?></b></td>
                                        ...
                                        for($i=0; $i<count($programslist);$i++){  
                                                 ...
                                                 $start_form_id =   $this->Entrytest_model->getStartIdForm($programslist[$i]['program_id'], $s_d);
                                               
                                                
                                                if($start_form_id == $programslist[$i]['start_form_id'])
                                                {
                                                    $start_frm_id = $programslist[$i]['start_form_id'];
                                                }else{
                                                    $start_frm_id = $programslist[$i]['start_form_id']+1;
                                                }
