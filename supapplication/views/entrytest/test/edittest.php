                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">                               
                                <h4 class="lighter">Update Test</h4>
                            </div>
                                       ...
                                       <hr />
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                <form class="form-horizontal" id="batchform" method="POST" action="<?php echo base_url()?>entrytest/update_test" enctype="multipart/form-data" />
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <input style="width: 188px;" type="text" name="number" id="number" value="<?php echo $test[0]['test_no']; ?>" class="span5" />
                                                            <input style="width: 188px;" type="hidden" name="test_id" id="test_id" value="<?php echo $test[0]['test_id']; ?>" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="span12">
                                                            <select style="width: 188px;" id="campaign" name="campaign" class="chzn-select" data-placeholder="Click to Choose...">                                                                
                                                                <?php foreach ($campaign as $row) { ?>
                                                                    <option <?php if ($test[0]['campaign_id'] == $row['campaign_id']) echo 'selected="selected"' ?> value="<?php echo $row['campaign_id'] ?>"><?php echo $row['campaign_name'] ?></option> 
                                                                 <?php } ?>																			
                                                            </select>
                                                        </div>
                                                    </div>
                                               ...
                                               <div style="width: 100%; float: left;margin-bottom: 15px" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 180px;">
                                                      <div class="span12">
                                                        <input style="width: 188px;" type="text" name="date" id="date" value="<?php echo $test[0]['test_date']; ?>" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly/>
                                                ...
                                                <div style="width: 100%; float: left;margin-bottom: 15px" class="control-group">
                                                    ...
                                                    <div class="input-append bootstrap-timepicker">
                                                        <input style="width:147px" id="timepicker1" name="time" type="text" value="<?php echo $test[0]['test_time']; ?>" class="input-small" />
                                                        <span class="add-on">
                                                            <i class="icon-time"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <input style="width: 188px;" type="text" name="venue" value="<?php echo $test[0]['test_venue']; ?>"" id="venue" class="span5" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="width: 100%;margin-bottom: 25px; float: left" class="control-group">
                                                    ...
                                                    <div class="controls" style="margin-left: 180px;">
                                                        <div class="span12">
                                                            <select style="width: 188px;" id="status" name="status"  class="chzn-select" data-placeholder="Click to Choose...">                                                                
                                                                <option <?php if($test[0]['status'] == 'In Process')echo 'selected="selected"'; ?> value="In Process"> In Process </option>
                                                                <option <?php if($test[0]['status'] == 'Completed')echo 'selected="selected"'; ?> value="Completed"> Completed </option>
