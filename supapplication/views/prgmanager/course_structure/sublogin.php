	...
	<body>
    	<div id="mainbackground">
    		<div id="wrapper">
                ...
                <p id="adminpara">ADMIN LOGIN</p>
                <div id="overallbackground">
                <div id="wholemiddlearea">
                    <form name="progmng_login" id="progmng_login" method="post"  onsubmit="return validate()" action="<?php echo base_url()?>programmanagers/sub_login">
                	<div id="loginarea">
                    	<div id="image">
...
function validate(){
var uname = document.progmng_login.username.value;
var pass  = document.progmng_login.password.value;

if(uname == '')
{
    alert('Username is Required.');
    document.progmng_login.username.focus();
    return false;
}
if(pass == '')
{
    alert('Password is Required.');
    document.progmng_login.password.focus();
    return false;
}
