<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>							
                <a href="" style="text-decoration: none">Offered Courses </a>
            </li>						
        </ul><!--.breadcrumb-->
                    ...
                    <div class="span12">                                                                     
                                ...
                                <div class="row-fluid">                                    
                                    <div class="table-header">
                                        <h3>Offered Courses For Current Session (<a href="<?php echo base_url();?>programmanagers/update_course_offered/" style="color: white">Update All Offered Courses</a>)</h3>
                                    </div>
