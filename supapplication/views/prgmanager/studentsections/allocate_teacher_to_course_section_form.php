<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>							
                <a href="" style="text-decoration: none">Course Sections Teacher Allocation</a>
            </li>						
        </ul><!--.breadcrumb-->
    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>programmanagers/save_allocate_teacher_to_course_section" enctype="multipart/form-data" />
                                        ...
                                        <div class="controls">
                                            <div class="span12">
                                                <select name="teacher" id="teacher">
                                                    ...
                                                    <?php 
                                                      foreach ($teachers as $pp){ 
                                                    ?>
                                                      <option value="<?php echo $pp["emp_id"];?>"><?php echo $pp["employee_name"]; ?> </option>
                                                    <?php  } ?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
      ...
      function all_setting_list(){
        ...
        $.ajax({
            ...
            url:"<?php echo base_url();?>programmanagers/js_list_teacher_course",
