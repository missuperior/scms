...
<div class="main-content">
    ...
    <div class="page-content">	
        ...
        <div class="page-header position-relative">
            <h1>Allocated Teachers To Sections and Courses</h1>
        </div><!--/.page-header-->
...
<!--                                <h4 class="lighter">Make Students Section for first Semester ()</h4>-->
                                <h4 class="lighter">
Allocated Teachers To Sections and Courses
 </h4>
                            </div>
...
<!--                                                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>programmanagers/view_student_sections" enctype="multipart/form-data" />-->
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="section">Sections:</label>

                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="section" id="section" onchange="getSectionTeachser(this.value);" >
                                                ...
                                                <div id="seccc" style="width:100%;float:left;">
...
<!--                                                <button class="btn btn-success btn-next" data-last="Finish">
        ...
        function getSectionTeachser(value)
        {
            ...
            if(value!=""){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>programmanagers/ajax_section_batch_teachser_StudentOffice",
