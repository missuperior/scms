                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="batch" id="batch">
                                                                ...
                                                                ?>
                                                                  <option <?php  echo $allocated_course[0]['batch_id'] == $pp["batch_id"]  ? 'selected="selected"' : '';  ?> value="<?php echo $pp['batch_id'] ; ?>">
                                                                      Batch: <?php echo $pp['batch_type'] .' <==> '.$pp['batch']; ?> 
                                                                  </option>
                                                                <?php  } ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="teacher" id="teacher">
                                                                ...
                                                                <option <?php  echo $allocated_course[0]['teacher_id'] == $r['emp_id'] ? 'selected="selected"' : '';  ?> value="<?php echo $r['emp_id']; ?>"><?php echo $r['employee_name'].' <=> '.$r['designation_title'].' <=> '.$r['department_name']; ?> </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
