...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>							
                <a href="" style="text-decoration: none">Students in Courses</a>
            </li>						
        </ul><!--.breadcrumb-->
    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>advisor/all_registered_students_list" enctype="multipart/form-data" />
                <div class="row-fluid">
                    <div class="span12">  
...
<script type="text/javascript">
    ...
    function getCourseSectionList() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>advisor/AllStudentsList",
