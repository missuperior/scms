    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <form class="form-horizontal" id="courseform" method="POST" action="<?php echo base_url();?>advisor/view_students_list" enctype="multipart/form-data" />
                <div class="row-fluid">
                    <div class="span12">                                                                     
                                <div class="row-fluid">                                    
                                    <div class="table-header">
                                       <h3>View Courses Offered Form</h3>
                                    </div>
                                    ...
                                    <div class="control-group">
                                                    <label class="control-label" for="session">Session In Which Students Will Be Registered:</label>
                                                    <div class="controls">
                                                        <div class="span12">
                                                            <select name="session" id="session" onchange="getStudentList();" >
...
<script type="text/javascript">
    ...
    function getStudentList() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>advisor/getAllStudents",
