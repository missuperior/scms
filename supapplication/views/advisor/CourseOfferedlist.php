                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                        ...
                        <?php if (!empty($RegisteredCourse)) { ?>
                            <div class="row-fluid">                                    
                                <div class="table-header">
                                    <h3>Student Already Registered Courses for Session:<?php echo $sessionna; ?>  :Move to Section <select name="section_change" id="section_change" onchange="change_section();"><option value="0">Select Section</option><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option><option value="E">E</option></select></h3>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($RegisteredCourse as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td id="course_sections"><?php echo $row['course_section']; ?></td>
...
function change_section() {
        var batch       = '<?php echo $_GET['batch_id']; ?>';
        var prog        = '<?php echo $_GET['program_id']; ?>';
        var session_id  = '<?php echo $_GET['session_id']; ?>';
        var student_id  = '<?php echo $_GET['student_id']; ?>';
        var section     = $('#section_change').val();
        //alert(section);
        $.ajax({
            type:'POST',
            data:{
            ...
            url: "<?php echo base_url();?>advisor/UpdateStudentCourse",
            success:function(data){alert('Section Updated') ; $("#course_sections").html(data);},
            error: function(){alert('Internet Gone, Please Try Again');}
        });
    }
