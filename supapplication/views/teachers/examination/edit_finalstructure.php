            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>teachers/update_final_structure" enctype="multipart/form-data" />

                                                
                                                 <div class="control-group" style="margin-bottom: 0px; color: mediumslateblue">
                                                    <label style="margin-bottom: 25px; margin-left: 150px;" class="control-label" for="city">Final Total Marks :</label>
                                                    <label style="width:65px" class="control-label" for="city">
                                                        <?php echo $final_total = $final->final_value_1+$final->final_value_2+$final->final_value_3+$final->final_value_4+$final->final_value_5+$final->final_value_6+$final->final_value_7; ?>
                                                    </label>                                                    
                                                </div>
                                                ...
                                                <input type="hidden" name="final_structure_id" value="<?php echo $final->final_course_structure_id; ?>" class="span5" />
                                                <input style="width: 100px;" placeholder="Marks" type="hidden" name="final_total" value="<?php echo $final_total; ?>" id="marks1" class="span5" />
