                            ...
                            <div class="row-fluid">                                             
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover">
                                        ...
                                        for($i=0; $i < $coiunt ; $i++){
                                                ...
                                                $res            =   $this->Teachers2_model->CheckMidResult_SingleStudent($check_data);
                                                $res2           =   $this->Teachers2_model->CheckFinalResult_SingleStudent($check_data);
                                                    ...
                                                    <td>
                                                       ...
                                                       <?php } else{  ?>
                                                                    <?php if($res < 1){?>
                                                                     ...
                                                                     <a  href="<?php echo base_url();?>teachers/students_list_for_mid_SingleStudent/?student_id=<?php echo $student_id;?>&teacher_id=<?php echo $info[$i]['teacher_id'];?>&course_id=<?php echo $info[$i]['course_id'];?>&program_id=<?php echo $info[$i]['program_id'];?>&semester=<?php echo $info[$i]['semester'];?>&course_section=<?php echo $info[$i]['course_section'];?>&batch_id=<?php echo $info[$i]['batch_id'];?>&session_id=<?php echo $info[$i]['current_session_id'];?>">
                                                                        Add Mid                                                                    
                                                                     </a>
