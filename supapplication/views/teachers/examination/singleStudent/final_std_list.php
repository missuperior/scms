                ...
                <div class="row-fluid">
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                             
                                    ...
                                    <form name="postChallan" id="postChallan" onsubmit="return confirm('Are you sure ?');" action="<?php echo  base_url()?>teachers/add_final_result_SingleStudent" method="post" >
                                    <table id="example11" class="table table-striped table-bordered table-hover">
                                        ...
                                        <input type="hidden" id="course_section" name="course_section" value="<?php echo $section; ?>" />
                                        ...
                                        $jj         = 0;
                                        for($i=0; $i < $std_lis ;$i++){ 
//                                            echo 'Student_id '.$student_id;die;
...
<!--                                                                   <input type="hidden" id="semester" name="semester" value="<?php echo $students[$i]['semester']; ?>" />-->
                                                            ...
                                                            <td><input tabindex="<?php echo $line1_tab;?>"   style="width:50px" <?php echo $final_val1; ?> name="o_marks1[]" type="text" id="a<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line2_tab;?>"   style="width:50px" <?php echo $final_val2; ?> name="o_marks2[]" type="text" id="b<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line3_tab;?>"   style="width:50px" <?php echo $final_val3; ?> name="o_marks3[]" type="text" id="c<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line4_tab;?>"   style="width:50px" <?php echo $final_val4; ?> name="o_marks4[]" type="text" id="d<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line5_tab;?>"   style="width:50px" <?php echo $final_val5; ?> name="o_marks5[]" type="text" id="e<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line6_tab;?>"   style="width:50px" <?php echo $final_val6; ?> name="o_marks6[]" type="text" id="f<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
                                                            <td><input tabindex="<?php echo $line7_tab;?>"   style="width:50px" <?php echo $final_val7; ?> name="o_marks7[]" type="text" id="g<?php echo $i;?>" onkeyup="validate_obtained_marks(this.id,this.value)" class="span6"></td>
