                    ...
                    <div class="span12">                                                                     
                            <div class="row-fluid">                                                      
                                    <div class="table-header">                                        
                                        <h3 id="title">Month Received Report</h3>                                       
                                    </div>                                                                    
...
<!--                                           <tr style="font-size: 10px">                                               
                                               ...
                                               <td colspan="2"><h3 style="text-align:right">Campus/Program Wise Roll# Report</h3></td>                                                                                                                                                
                                           </tr>
                                           <tr style="font-size: 10px">                                                
                                               <td colspan="3"><b>Campus : <?php  //if($campus_id == 0) { echo 'All';}else{ echo $roll_no_report[0]['campus_name'];} ?></b></td>
                                                <td colspan="2"><b>Campaign : <?php //echo $roll_no_report[0]['campaign_name']; ?></b></td>
                                           </tr>-->
                                           <tr>
                                              <th>Campus</th>
                                              <?php 
