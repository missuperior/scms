                                            ...
                                            <tr>                                                                                        
                                               ...
                                               <?php if($row['admission_stage'] == 2 || $row['admission_stage'] == 3)
                                                ...
                                                <?php if($result == 0){
                                                  ...
                                                  if($row['roll_no'] == ''){
                                                    ?>
                                                            <a class="green" href="<?php echo base_url()?>accounts/student_package/?student_id=<?php echo $row['student_id']; ?>">Add Package</a>
                                                  <?php }else{?>
                                                             <a class="green" href="<?php echo base_url()?>accounts/student_package2/?student_id=<?php echo $row['student_id']; ?>">Add Package</a>
                                                  <?php }?>
