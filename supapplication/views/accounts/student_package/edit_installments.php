                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main" style="min-height: 100px">
                                <form class="form-horizontal" name="searchChallan" id="searchChallan" method="POST" action="<?php echo  base_url()?>accounts/edit_installments" enctype="multipart/form-data" />
                                ...
                                <div class="row-fluid" style="float:left; width:220px">
                                    ...
                                    <select class="chzn-select" name="session" id="form-field-select-3" data-placeholder="Choose a Country...">                                        
                                       <?php foreach ($sessions as $row) { 
                                           if($row['session_id'] >= $enrolled_session_id){?>
                                        <option <?php if ($session_id == $row['session_id']){echo 'selected="selected"';}  ?> value="<?php echo $row['session_id'] ?>"><?php echo $row['session']; ?></option> 
                                       <?php }} ?>  
                                    </select>
                                </div>
                                ...
                                <button class="btn btn-purple btn-small" style="margin-top:22px; margin-left: 50px" >
                                    Search
...
<!--                                                            <input style="width: 188px; " type="text" name="package" id="package" value="50000" class="span6" readonly/> -->
                                                            <input style="width: 188px; " type="text" name="package" id="package" value="<?php echo $package-$pkg;?>" class="span6" readonly/> 
                                                ...
                                                <div  class="control-group" id="div_<?php echo $std_installments[$i]['installment_id']; ?>" >
                                                    ...
                                                    <label style="width: 130px;" class="control-label" for="email">Installment <?php echo $i+1; ?> : <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>
                                                    ...
                                                    <div class="controls" style="margin-left: 140px;">
                                                        <div class="span12">
                                                            ...
                                                            <input style="width: 100px;" type="text" name="discount[]" id="<?php echo "discount".$i; ?>" value="<?php echo $std_installments[$i]['additional_discount']; ?>" class="span6"   placeholder="Discount"  />% - 
                                                            ...
                                                            <!--<input style="width: 100px;" type="hidden" name="payable[]" id="<?php echo "payable2".$i; ?>" value="<?php echo $std_installments[$i]['payable']; ?>" class="span6" placeholder="Payable"  readonly/> --->
                                                            ...
                                                            <input style="width: 200px;" type="text" name="remarks[]" id="<?php echo "remarks".$i; ?>" value="<?php echo $std_installments[$i]['remarks']; ?>" placeholder="Remarks"  class="span7"/>
