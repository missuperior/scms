                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-body">
                                ...
                                <form class="form-horizontal" id="cityform" method="POST" action="<?php echo base_url()?>accounts/add_fine" enctype="multipart/form-data" />
                                            ...
                                            <div class="row-fluid wizard-actions">
                                                <input value="Save" type="submit" name="save" class="btn btn-success btn-next" data-last="Finish ">
                                                    
                                                <input value="Save & Post" type="submit" name="post" class="btn btn-success btn-next" data-last="Finish ">
