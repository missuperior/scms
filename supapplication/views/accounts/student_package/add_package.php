              ...
              <div class="widget-body">
                <div class="widget-main">
                  ...
                  <div class="row-fluid">
                    ...
                    <form class="form-horizontal" id="studentform" method="POST" action="<?php echo base_url(); ?>accounts/add_student_package" enctype="multipart/form-data" />
                    ...
                    <div class="step-content row-fluid position-relative" id="step-container">
                      <div class="step-pane active" id="step1">
                        ...
                        <input type="hidden" name="type" id="type" value="<?php echo $package[0]['type'];?>" class="span6" /> 
                       ...
                       <?php } else{
                           ...
                           // add 5 % tax in total package
                           
                           $tax     =   ($package[0]['admission_fee'] + $package[0]['session_fee'] + $package[0]['misc_fee']) / 100 * 5;
                           ?>
                        
                        <div  class="control-group">
                          <label style="width: 130px;" class="control-label" for="email">5% Tax : <img src="<?php echo base_url() ?>assets/img/star.jpg" width="6"/></label>

                        <div class="controls" style="margin-left: 140px;">
                            <div class="span12">
                                <input style="width: 120px; " type="text" name="tax" id="tax" value="<?php echo $tax; ?>" class="span6"  readonly/> 
<!--                                <input style="width: 140px;" type="text" name="misc_discount1" id="misc_discount1" value="" class="span6" maxlength="5" placeholder="Discount(e.g 5000)" /> - 
                                <input style="width: 140px;" type="text" name="misc_discount2" id="misc_discount2" value="" class="span6" maxlength="3" placeholder="Discount(e.g 25%)" readonly/>% - 
                                <input style="width: 120px;" type="text" name="misc_payable" id="misc_payable" value="<?php echo $package[0]['misc_fee'];?>" class="span6" placeholder="Payable"  readonly/>-->
                            </div>
                       ...
                       <?php } ?>
                        ...
                        <div  class="control-group">
                          ...
                          <?php 
                                $total =     $package[0]['admission_fee'] + $package[0]['session_fee'] + $package[0]['misc_fee'] + $tax ;
