          ...
          <a href="" style="text-decoration: none" class="pink">                       
            ...
            <div class="widget-box">
              <div class="widget-header widget-header-blue widget-header-flat">
                <h4 class="lighter">Change Due Date Form</h4>
              </div>
                ...
                <div class="widget-main">
                  <div class="row-fluid">													
                    ...
                    <div class="step-content row-fluid position-relative" id="step-container">
                     ...
                     <form class="form-horizontal" id="rollnoForm" method="POST" action="<?php echo base_url(); ?>accounts/change_due_date" />
                      ...
                      <?php } ?>
                        ...
                        <div style="width: 100%; float: left;margin-bottom: 15px; margin-left: 30px;" class="control-group">
                            <label style="width: 130px;" class="control-label" for="id-date-picker-1">Start Date :</label>
                        ...
                        <div style="width: 100%; float: left;margin-bottom: 15px; margin-left: 30px;" class="control-group">
                            <label style="width: 130px;" class="control-label" for="id-date-picker-1">End Date :</label>
                        ...
                        <div style="width: 100%; float: left;margin-bottom: 15px; margin-left: 30px;" class="control-group">
                            <label style="width: 130px;" class="control-label" for="id-date-picker-1"> New Due Date :</label>

                            <div class="controls" style="margin-left: 150px;">
                                <div class="span12">
                                    <input style="width: 220px;" type="text" name="new_date" id="new_date" value="<?php echo set_value('to_date'); ?>" class="span6 date-picker" data-date-format="yyyy-mm-dd" readonly/>
                                </div>
                            </div>
                        </div>
