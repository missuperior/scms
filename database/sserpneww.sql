...
--
-- Host: localhost
-- Generation Time: Mar 18, 2014 at 03:59 PM
...
INSERT INTO `initial_form` (`initial_form_id`, `form_no`, `inquiry_id`, `operator_id`, `initial_campus_id`, `submit_date`) VALUES
(1, 'Form-123', 2, 1, 15, '0000-00-00');
...
INSERT INTO `installments` (`installment_id`, `student_id`, `program_id`, `semester_id`, `fee`, `fine`, `additional_discount`, `payable`, `due_date`, `status`, `operator_id`) VALUES
(1, 2, 3, 4, 55000, 2500, 14500, 43000, '2014-03-20', 'unpaid', '1'),
(2, 2, 9, 4, 17800, 1000, 5000, 13800, '2014-03-22', 'unpaid', '1');
